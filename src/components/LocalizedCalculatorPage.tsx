...
const pageCopies: Record<Exclude<CalculatorLocaleCode, "pl">, CalculatorPageCopy> = {
  ...
  bg: {
    language: "Bulgarian",
    ogLocale: "bg_BG",
    urlPath: "/bg/kalkulator",
    title: "Калкулатор за обезщетение при полет | 250, 400 или 600 €",
    description:
      "Безплатен калкулатор по EU261 и UK261 за забавени полети, отменени полети, отказан бординг и изпуснати връзки.",
    eyebrow: "Безплатен калкулатор EU261 и UK261",
    heading: "Калкулатор за обезщетение при полет",
    intro:
      "Проверете за няколко стъпки дали забавен, отменен или свръхрезервиран полет може да даде право на 250, 400 или 600 евро на пътник.",
    afterCalculator:
      "Резултатът е първоначална оценка. ClaimWinger след това проверява резервацията, реалния час на пристигане, причината за проблема и отговорността на авиокомпанията.",
    bandsHeading: "Размер на обезщетението според разстоянието",
    bandsDescription:
      "EU261 и UK261 използват фиксирани суми. Цената на билета не определя размера на обезщетението.",
    bandShort: "Къса дистанция",
    bandMedium: "Средна дистанция",
    bandLong: "Дълга дистанция",
    bandShortDescription: "Полет до 1 500 km, често кратък европейски маршрут.",
    bandMediumDescription: "Полет от 1 500 до 3 500 km и много по-дълги вътрешноевропейски маршрути.",
    bandLongDescription: "Полет над 3 500 km, включително много дълги маршрути от Европа.",
    rulesHeading: "Какво проверява калкулаторът",
    rules: [
      "Дали заминаването или пристигането попадат в логиката на EU261, UK261, Швейцария или ЕИП.",
      "Дали забавянето при пристигане, отмяната, отказаният бординг или изпуснатата връзка достигат законовия праг.",
      "Дали оперативният превозвач е покрит, когато полетът пристига в Европа от държава извън зоната.",
      "Дали извънредни обстоятелства изискват ръчна правна проверка преди подаване на иск.",
    ],
    faqHeading: "FAQ: калкулатор за обезщетение",
    faq: [
      {
        question: "Краен ли е резултатът от калкулатора?",
        answer:
          "Не. Това е бърза първоначална оценка според маршрута и въведената ситуация. Реален иск изисква проверка на документи, час на пристигане и причина за проблема.",
      },
      {
        question: "Калкулаторът проверява ли отменени полети?",
        answer:
          "Да. Той покрива забавяне, отмяна, отказан бординг и изпусната връзка в една резервация. При отмяна са важни срокът на уведомление и алтернативният полет.",
      },
      {
        question: "Обезщетението изчислява ли се на пътник?",
        answer:
          "Да. EU261 и UK261 обикновено изчисляват обезщетението на пътник, а не на резервация.",
      },
      {
        question: "Кога сумата може да бъде 600 евро?",
        answer:
          "Обикновено при маршрути над 3 500 km, когато полетът е в обхвата на правилата и прагът за забавяне или отмяна е изпълнен.",
      },
    ],
    relatedHeading: "Полезни страници",
    related: [
      { label: "Забавен полет", href: "/bg/zabaven-polet", description: "Правила при пристигане с 3+ часа закъснение." },
      { label: "Отменен полет", href: "/bg/otmenen-polet", description: "Права при отмяна, възстановяване и премаршрутиране." },
      { label: "Блог", href: "/bg/blog", description: "Бъдещи ръководства за EU261, авиокомпании и маршрути." },
    ],
    finalCtaTitle: "Оценете случая преди подаване",
    finalCtaText:
      "Започнете с калкулатора, след което преминете към ClaimWinger, ако маршрутът и ситуацията изглеждат обещаващи.",
    finalCtaLabel: "Отворете калкулатора",
  },
  cs: {
    language: "Czech",
    ogLocale: "cs_CZ",
