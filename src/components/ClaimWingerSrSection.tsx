...
type ClaimWingerSrSectionProps = {
  className?: string;
  title?: string;
  description?: string;
  badge?: string;
...
export function ClaimWingerSrSection({
  className = "",
  title = "Proverite svoj slučaj kroz ClaimWinger formular",
  description = "ClaimWinger još uvek nema posebnu srpsku verziju, pa je formular na engleskom jeziku. Možete ga koristiti za kašnjenje leta, otkazan let, uskraćeno ukrcavanje ili propuštenu vezu po Uredbi EU 261 i UK261.",
  badge = "Bez plaćanja unapred",
  ctaLabel = "Otvorite ClaimWinger",
  ctaHref = buildClaimWingerSrLink("home", {
    medium: "embedded_cta",
    campaign: "sr_claim_entry",
  }),
  loadingLabel = "Učitavanje engleskog formulara...",
  loadingDescription = "Za koji sekund videćete ClaimWinger formular za proveru vašeg slučaja.",
  placement = "sr_embed_section",
}: ClaimWingerSrSectionProps) {
  ...
  return (
    <section className={wrapperClassName} data-claimwinger-embed="true">
      <div className="mb-6 rounded-3xl border border-sky-200 bg-gradient-to-br from-sky-50 via-white to-amber-50 p-6 shadow-sm dark:border-sky-900 dark:from-sky-950/40 dark:via-gray-900 dark:to-gray-900">
        ...
        <div className="mt-6">
          <a
            ...
            onClick={() => trackClaimWingerSrClick(placement, ctaHref)}
      ...
      <ClaimWingerHeroEmbed
        ...
        lang="en"
        queryParams={{
          utm_source: "problemlot-sr",
          utm_medium: "embed",
          utm_campaign: "sr_claim_entry",
          utm_language: "sr",
        }}
