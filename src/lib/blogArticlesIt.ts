...
export const blogArticlesIt: BlogArticle[] = [
  ...
  {
    slug: "aeroporto-olbia-risarcimento",
    title: "Aeroporto Olbia Costa Smeralda (OLB): Risarcimento Voli 2026",
    excerpt: "Volo in ritardo a Olbia OLB? CE 261/2004, €250–€400, alta stagione Costa Smeralda, Ryanair/easyJet/Volotea, Maestrale non straordinario, procedura ENAC.",
    date: "2026-03-20",
    readTime: "7 min",
    category: "Aeroporti",
    featured: false,
  ...
  {
    slug: "aeroporto-copenaghen-risarcimento",
    title: "Aeroporto Copenaghen CPH: Risarcimento Voli 2026 — fino a €600",
    excerpt: "Volo in ritardo a Copenaghen CPH? CE 261/2004, €400–€600, hub SAS, Norwegian, neve non straordinaria, connessioni Nord America, TBST vs ENAC.",
    date: "2026-03-20",
    readTime: "8 min",
    category: "Hub Europei",
    featured: false,
  ...
  {
    slug: "brussels-airlines-risarcimento",
    title: "Brussels Airlines: Risarcimento Voli 2026 — CE 261/2004 guida completa",
    excerpt: "Volo Brussels Airlines in ritardo o cancellato? CE 261/2004, €250–€600, hub Bruxelles BRU, rotte Africa subsahariana, codeshare Lufthansa Group, DGNB vs ENAC.",
    date: "2026-03-19",
    readTime: "7 min",
    category: "Compagnie Aeree",
    featured: false,
  ...
  {
    slug: "aeroporto-barcellona-risarcimento",
    title: "Aeroporto Barcellona El Prat (BCN): Risarcimento Voli 2026",
    excerpt: "Volo in ritardo a Barcellona BCN? CE 261/2004, €250–€400, hub Vueling, BCN vs Girona GRO vs Reus REU, AESA vs ENAC.",
    date: "2026-03-19",
    readTime: "8 min",
    category: "Hub Europei",
    featured: false,
