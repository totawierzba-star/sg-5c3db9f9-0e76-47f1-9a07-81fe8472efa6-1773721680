...
export default function BlogIndexZh() {
  ...
  return (
    <LayoutZh>
      <SEO 
        title="航班延误赔偿博客 | EU261法规指南和航空公司索赔攻略"
        description="专为中国乘客打造的欧洲航班延误/取消赔偿知识库。深度解析EU 261/2004法规、各大航空公司索赔策略和真实案例分享。"
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-4">
            深度解析EU 261/2004法规，分享各大航空公司索赔攻略，帮助中国乘客维护权益
          </p>
          
          {/* Article Counter */}
          <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-700 px-4 py-2 rounded-full text-sm font-medium">
            <span className="text-lg">📝</span>
            <span>已发布 {totalArticles} 篇深度文章</span>
          </div>
        </div>
