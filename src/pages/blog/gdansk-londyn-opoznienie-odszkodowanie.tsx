...
export default function GdanskLondynOpoznienieOdszkodowanie() {
  return (
    <Layout>
      <SEO
        title="Gdańsk–Londyn opóźnienie — odszkodowanie Ryanair"
        description="Lot Gdańsk–Londyn opóźniony? Sprawdź, jak uzyskać 400 € odszkodowania od Ryanair i Wizz Air. Praktyczny przewodnik."
        url="https://problemlot.pl/blog/gdansk-londyn-opoznienie-odszkodowanie"
      />
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <nav className="mb-8 text-sm text-slate-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900">Gdańsk–Londyn opóźnienie</span>
          </nav>
          ...
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">
              Gdańsk–Londyn opóźnienie — odszkodowanie Ryanair
            </h1>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-700 mb-4">
                  Lot Gdańsk–Londyn opóźniony o <strong>3+ godziny</strong>? Przysługuje Ci <strong>400 € odszkodowania</strong> 
          ...
          <div className="prose prose-slate max-w-none mb-12">
            <p className="text-lg text-slate-700 leading-relaxed">
              Trasa <strong>Gdańsk–Londyn</strong> to kluczowe połączenie z północnej Polski do Wielkiej Brytanii — obsługiwane 
              głównie przez Ryanair (Stansted) i Wizz Air (Luton). Rocznie leci nią ponad 350,000 pasażerów, z czego 
              <strong>~60% to Polacy pracujący w UK</strong>.
            </p>
            <p className="text-lg text-slate-700 leading-relaxed">
              Jeśli Twój lot z Gdańska do Londynu został opóźniony o <strong>3 godziny lub więcej</strong>, masz prawo do odszkodowania — 
              <strong>250 € lub 400 €</strong> zależnie od dokładnego dystansu i lotniska docelowego. W tym artykule dowiesz się, 
              jak skutecznie wyegzekwować swoje prawa i uzyskać pieniądze.
            </p>
          </div>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-6 flex items-center gap-3">
              ...
              Dlaczego loty Gdańsk–Londyn są często opóźniane?
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                <h3 className="font-bold text-blue-900 mb-3 flex items-center gap-2">
                  ...
                  Problemy w Gdańsku (GDN)
                </h3>
                <ul className="space-y-2 text-slate-700">
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                    <span><strong>Rotacja floty</strong> — samolot leci GDN→STN→GDN→MAD → łańcuch opóźnień</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                    <span><strong>Jeden pas startowy</strong> — Gdańsk Rębiechowo ma ograniczoną przepustowość</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                    <span><strong>Mgły nad Zatoką</strong> — częste ograniczenia widoczności (jesień/zima)</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-6">
              <h3 className="font-bold text-slate-900 mb-3">📊 Statystyki opóźnień GDN–LON (2025)</h3>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-6 flex items-center gap-3">
              ...
              Ile odszkodowania za opóźnienie Gdańsk–Londyn?
            </h2>

            <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-lg mb-6">
              <h3 className="font-bold text-blue-900 mb-2">
                Kwota zależy od lotniska docelowego w Londynie
              </h3>
              <p className="text-slate-700 text-sm leading-relaxed">
                Odszkodowanie w WE 261 jest uzależnione od dystansu lotu. Gdańsk–Londyn to różne dystanse zależnie od lotniska:<br/>
                • <strong>Stansted (STN)</strong>: ~1,450 km → <strong>250 €</strong><br/>
                • <strong>Luton (LTN)</strong>: ~1,480 km → <strong>250 €</strong><br/>
                • <strong>Gatwick (LGW)</strong>: ~1,550 km → <strong>400 €</strong> (powyżej 1,500 km)<br/>
                • <strong>Heathrow (LHR)</strong>: ~1,560 km → <strong>400 €</strong>
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-8 mb-6">
              <div className="text-center mb-6">
                <div className="text-sm font-bold text-blue-800 uppercase tracking-wide mb-2">
                  Najczęstsza trasa: GDN → STN (Ryanair)
                </div>
            ...
            <div className="bg-white border border-slate-200 rounded-lg p-6">
              ...
              <div className="text-sm space-y-2">
                <p>
                  <strong>Twój lot:</strong> Ryanair FR 2288, GDN → STN, 22 maja 2025<br/>
                  <strong>Planowane wylądowanie:</strong> 09:15<br/>
                  <strong>Rzeczywiste wylądowanie:</strong> 12:50 (opóźnienie <strong>3h 35min</strong>)
                </p>
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mt-4">
                  <div className="text-green-900">
                    ✅ <strong>Opóźnienie &gt;3h</strong> → Przysługuje odszkodowanie<br/>
                    ✅ <strong>Dystans ~1,450 km</strong> → Stawka: 250 €<br/>
                    ✅ <strong>Termin na roszczenie:</strong> Do 22 maja 2028 (3 lata)
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Jak uzyskać odszkodowanie za opóźniony lot Gdańsk–Londyn?
            </h2>
            ...
            <div className="space-y-4">
              <div className="border border-slate-200 rounded-lg p-6">
                <h3 className="font-bold text-lg text-slate-900 mb-3">
                  Czy Brexit wpływa na odszkodowanie za lot Gdańsk–Londyn?
                </h3>
                <p className="text-slate-700">
                  <strong>NIE — UK 261 działa tak samo jak WE 261.</strong> Po Brexicie Wielka Brytania przyjęła UK Regulation 261/2004, 
                  które jest kopią unijnego rozporządzenia. Loty GDN→LON nadal są chronione.
                </p>
              </div>
              ...
              <div className="border border-slate-200 rounded-lg p-6">
                <h3 className="font-bold text-lg text-slate-900 mb-3">
                  Czy lot powrotny Londyn–Gdańsk też daje prawo do odszkodowania?
                </h3>
                <p className="text-slate-700">
                  <strong>Tak!</strong> WE 261 obowiązuje dla lotów do UE (wszystkie linie) oraz z UE (tylko linie UE). 
                  Lot LON→GDN = lot do UE, więc odszkodowanie przysługuje.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 md:p-12 text-white text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Odzyskaj swoje 250 € za opóźniony lot Gdańsk–Londyn
              </h2>
          ...
          <section className="border-t border-slate-200 pt-8">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              ...
              <Link href="/blog/lotnisko-gdansk-rebiechowo-opozniony-lot" className="text-blue-600 hover:underline">
                → Lotnisko Gdańsk — opóźniony lot
              </Link>
