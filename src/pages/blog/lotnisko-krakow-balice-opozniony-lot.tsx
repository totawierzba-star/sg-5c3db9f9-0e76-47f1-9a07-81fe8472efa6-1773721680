...
export default function LotniskoKrakowBaliceOpoznionyLot() {
  return (
    <Layout>
      <SEO
        title="Lotnisko Kraków-Balice — odszkodowanie za opóźniony lot | ProblemLot.pl"
        description="Opóźniony lot z Krakowa KRK? Sprawdź, jak uzyskać 250-600 € odszkodowania. Ryanair, Wizz Air, LOT - poznaj swoje prawa jako pasażer."
        url="https://problemlot.pl/blog/lotnisko-krakow-balice-opozniony-lot"
      />
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Lotnisko Kraków-Balice — odszkodowanie za opóźniony lot
          </h1>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-700">
                <strong>Opóźniony lot z Krakowa KRK?</strong> Przy opóźnieniu &gt;3 godziny przysługuje Ci <strong>250-600 € odszkodowania</strong> według rozporządzenia WE 261/2004, niezależnie od linii lotniczej (Ryanair, Wizz Air, LOT) i ceny biletu.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="prose max-w-none">
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">
            Lotnisko Kraków-Balice (KRK) - drugie lotnisko w Polsce
          </h2>

          <p className="text-gray-700 leading-relaxed mb-6">
            <strong>Port Lotniczy im. Jana Pawła II Kraków-Balice (KRK)</strong> to <strong>drugie co do wielkości lotnisko w Polsce</strong>. Obsługuje rocznie około 9 mln pasażerów, oferując głównie połączenia europejskie. To kluczowa baza dla Ryanair i Wizz Air.
          </p>

          <div className="bg-gray-50 p-6 rounded-lg mb-6">
            <h3 className="font-bold text-lg text-gray-900 mb-3 flex items-center gap-2">
              <Plane className="w-5 h-5 text-blue-600" />
              Najważniejsze informacje o KRK
            </h3>
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span><strong>Kod IATA:</strong> KRK (Kraków)</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
              ...
              <li className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span><strong>Najpopularniejsze kierunki:</strong> Londyn, Dublin, Eindhoven, Dortmund, Oslo, Barcelona</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span><strong>Roczny ruch:</strong> ~9 mln pasażerów (2025)</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span><strong>Specjalizacja:</strong> Połączenia lowcost (Ryanair, Wizz Air dominują)</span>
              </li>
            </ul>
          </div>

          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">
            Ile wynosi odszkodowanie za opóźniony lot z Krakowa?
          </h2>
            ...
            <div className="space-y-3">
              <div className="bg-white p-4 rounded">
                <div className="flex justify-between items-center">
                  <span className="text-gray-700"><strong>Do 1500 km + opóźnienie &gt;3h</strong> (np. KRK-Londyn, Dublin, Oslo)</span>
                  <span className="text-2xl font-bold text-blue-600">250 €</span>
                </div>
              </div>
              <div className="bg-white p-4 rounded">
                <div className="flex justify-between items-center">
                  <span className="text-gray-700"><strong>1500-3500 km + opóźnienie &gt;3h</strong> (np. KRK-Barcelona, Lizbona, Ateny)</span>
                  <span className="text-2xl font-bold text-blue-600">400 €</span>
                </div>
              </div>
              <div className="bg-white p-4 rounded">
                <div className="flex justify-between items-center">
                  <span className="text-gray-700"><strong>Powyżej 3500 km + opóźnienie &gt;4h</strong> (rzadkie z KRK - głównie via)</span>
          ...
          <div className="bg-amber-50 border-l-4 border-amber-500 p-6 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2">Ważne dla pasażerów z Krakowa!</h3>
                <p className="text-gray-700">
                  <strong>Kraków-Balice obsługuje głównie loty europejskie do 1500 km.</strong> Oznacza to, że większość opóźnionych lotów kwalifikuje się do <strong>250 € odszkodowania</strong> (przy opóźnieniu &gt;3h).
                </p>
              </div>
            </div>
          </div>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">
            Najczęstsze problemy z opóźnionymi lotami z Krakowa KRK
          </h2>
          ...
          <div className="space-y-4 mb-6">
            <div className="border-l-4 border-red-500 pl-4">
              ...
              <p className="text-gray-700">
                Ryanair to <strong>największy przewoźnik w Krakowie</strong>. Często opóźnia loty z powodu <strong>"problemów operacyjnych"</strong> lub <strong>"rotacji samolotów"</strong>. To <strong>NIE są nadzwyczajne okoliczności</strong> - odszkodowanie przysługuje!
              </p>
            ...
            <div className="border-l-4 border-purple-500 pl-4">
              ...
              <p className="text-gray-700">
                Wizz Air ma dużą bazę w Krakowie i często <strong>automatycznie wystawia vouchery</strong> zamiast wypłacać odszkodowanie. Pasażer ma prawo <strong>żądać wypłaty gotówki</strong> - voucher jest dobrowolny!
              </p>
              <p className="text-gray-700 mt-2">
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              ...
              <p className="text-gray-700">
                Jeśli lecisz LOT <strong>KRK → WAW → dalej</strong> (np. do USA/Azji) i pierwszy odcinek się opóźnił, powodując utratę przesiadki, przysługuje Ci odszkodowanie za <strong>całą trasę</strong> (liczony dystans do celu końcowego)!
              </p>
              <p className="text-gray-700 mt-2">
            ...
            <div className="border-l-4 border-orange-500 pl-4">
              <h3 className="font-bold text-gray-900 mb-2">4. Opóźnienia w sezonie zimowym (mgła, oblodzenie)</h3>
              <p className="text-gray-700">
                Kraków leży w kotlinie - zimą często występują <strong>mgły i oblodzenie pasa</strong>. Jednak <strong>typowe warunki zimowe NIE są nadzwyczajną okolicznością</strong>. Linia musi być przygotowana na sezonowe warunki pogodowe!
              </p>
            </div>
          </div>

          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">
            Jak dochodzić odszkodowania za opóźniony lot z Krakowa? Krok po kroku
          </h2>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-gray-700">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0 mt-1" />
                      <span>Zdjęcia tablicy odlotów/przylotów w KRK (opcjonalnie)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0 mt-1" />
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 mb-3">
                    <strong>Wskaźnik odmów z Krakowa KRK:</strong> Ryanair odmawia w <strong>~31% przypadków</strong>, Wizz Air w <strong>24%</strong>, LOT w <strong>~18%</strong>. Często odmowy są bezpodstawne.
                  </p>
          ...
          <div className="bg-red-50 border-l-4 border-red-500 p-6 mb-6">
            ...
            <p className="text-gray-700 mt-4">
              <strong>Uwaga!</strong> Typowa zimowa mgła w Krakowie, "problemy operacyjne", "rotacja samolotów" czy "brak załogi" <strong>NIE SĄ nadzwyczajnymi okolicznościami</strong>. Linia musi być przygotowana na sezonowe warunki!
            </p>
          </div>
          ...
          <div className="space-y-4 mb-8">
            <details className="bg-gray-50 p-6 rounded-lg">
              <summary className="font-bold text-gray-900 cursor-pointer">
                Czy przysługuje mi odszkodowanie za lot Ryanair KRK-Londyn opóźniony o 4 godziny?
              </summary>
              <p className="text-gray-700 mt-3">
                <strong>Tak!</strong> KRK-Londyn to trasa <strong>do 1500 km</strong> (~1280 km), więc przy opóźnieniu &gt;3h przysługuje Ci <strong>250 € odszkodowania</strong> (jeśli opóźnienie nie było spowodowane nadzwyczajnymi okolicznościami).
              </p>
            </details>
            ...
            <details className="bg-gray-50 p-6 rounded-lg">
              <summary className="font-bold text-gray-900 cursor-pointer">
                Czy zimowa mgła w Krakowie to nadzwyczajna okoliczność?
              </summary>
              <p className="text-gray-700 mt-3">
                <strong>Zazwyczaj NIE!</strong> Mgła jest nadzwyczajną okolicznością tylko wtedy, gdy <strong>zamyka lotnisko całkowicie</strong> (wszystkie loty odwołane/opóźnione). Jeśli inne loty startują normalnie, a tylko Twój ma opóźnienie - odszkodowanie przysługuje!
              </p>
            </details>

            <details className="bg-gray-50 p-6 rounded-lg">
              <summary className="font-bold text-gray-900 cursor-pointer">
                Straciłem przesiadkę w Krakowie. Czy przysługuje odszkodowanie?
              </summary>
              <p className="text-gray-700 mt-3">
                <strong>Tak!</strong> Jeśli pierwszy lot się opóźnił, straciłeś przesiadkę w KRK i dotarłeś do celu końcowego z opóźnieniem &gt;3h, przysługuje Ci odszkodowanie za <strong>całą trasę</strong> (liczony dystans od startu do celu końcowego).
              </p>
            </details>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-8 rounded-lg my-12">
            <h2 className="text-2xl font-bold mb-4">
              Opóźniony lot z Krakowa KRK? Sprawdź swoje odszkodowanie!
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-8">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                Straciłeś przesiadkę w KRK? Sprawdź swoje prawa.
              </p>
            </Link>
          ...
          <section itemScope itemType="https://schema.org/FAQPage" className="hidden">
            <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
              <h3 itemProp="name">Czy przysługuje mi odszkodowanie za lot Ryanair KRK-Londyn opóźniony o 4 godziny?</h3>
              <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                <div itemProp="text">
                  Tak! KRK-Londyn to trasa do 1500 km (~1280 km), więc przy opóźnieniu większym niż 3 godziny przysługuje Ci 250 € odszkodowania według rozporządzenia WE 261/2004 (jeśli opóźnienie nie było spowodowane nadzwyczajnymi okolicznościami).
                </div>
              </div>
            </div>
            ...
            <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
              <h3 itemProp="name">Czy zimowa mgła w Krakowie to nadzwyczajna okoliczność?</h3>
              <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                <div itemProp="text">
                  Zazwyczaj NIE! Mgła jest nadzwyczajną okolicznością tylko wtedy, gdy zamyka lotnisko całkowicie (wszystkie loty odwołane/opóźnione). Jeśli inne loty startują normalnie, a tylko Twój ma opóźnienie - odszkodowanie przysługuje.
                </div>
              </div>
            </div>
