...
export default function LotniskoKrakowBaliceOdwolanyLot() {
  return (
    <Layout>
      <SEO
        title="Lotnisko Kraków-Balice — odszkodowanie za odwołany lot | ProblemLot.pl"
        description="Odwołany lot z Krakowa KRK? Sprawdź, jak uzyskać 250-600 € odszkodowania. Ryanair, Wizz Air, LOT - poznaj swoje prawa jako pasażer."
        url="https://problemlot.pl/blog/lotnisko-krakow-balice-odwolany-lot"
      />
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Lotnisko Kraków-Balice — odszkodowanie za odwołany lot
          </h1>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-700">
                <strong>Odwołany lot z Krakowa KRK?</strong> Przysługuje Ci <strong>250-600 € odszkodowania</strong> według rozporządzenia WE 261/2004, niezależnie od linii lotniczej (Ryanair, Wizz Air, LOT) i ceny biletu.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="prose max-w-none">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">
            Ile wynosi odszkodowanie za odwołany lot z Krakowa?
          </h2>
            ...
            <div className="space-y-3">
              <div className="bg-white p-4 rounded">
                <div className="flex justify-between items-center">
                  <span className="text-gray-700"><strong>Do 1500 km</strong> (np. KRK-Londyn, Dublin, Oslo)</span>
                  <span className="text-2xl font-bold text-blue-600">250 €</span>
                </div>
              </div>
              <div className="bg-white p-4 rounded">
                <div className="flex justify-between items-center">
                  <span className="text-gray-700"><strong>1500-3500 km</strong> (np. KRK-Barcelona, Lizbona, Ateny)</span>
                  <span className="text-2xl font-bold text-blue-600">400 €</span>
                </div>
              </div>
              <div className="bg-white p-4 rounded">
                <div className="flex justify-between items-center">
                  <span className="text-gray-700"><strong>Powyżej 3500 km</strong> (rzadkie z KRK - głównie via)</span>
          ...
          <div className="bg-amber-50 border-l-4 border-amber-500 p-6 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  <strong>Kraków-Balice obsługuje głównie loty europejskie do 1500 km.</strong> Oznacza to, że większość odwołanych lotów kwalifikuje się do <strong>250 € odszkodowania</strong>.
                </p>
              </div>
            </div>
          </div>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">
            Najczęstsze problemy z odwołanymi lotami z Krakowa KRK
          </h2>
          ...
          <div className="space-y-4 mb-6">
            <div className="border-l-4 border-red-500 pl-4">
              ...
              <p className="text-gray-700">
                Ryanair to <strong>największy przewoźnik w Krakowie</strong>. Często odwołuje loty <strong>ostatnio (np. 13 dni przed wylotem)</strong>, próbując uniknąć wypłaty odszkodowania. <strong>To nielegalne!</strong> Odszkodowanie przysługuje przy odwołaniu mniej niż 14 dni przed lotem.
              </p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">
            Jak dochodzić odszkodowania za odwołany lot z Krakowa? Krok po kroku
          </h2>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-gray-700">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0 mt-1" />
                      <span>Zdjęcia tablicy odlotów w KRK (opcjonalnie)</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="space-y-4 mb-8">
            <details className="bg-gray-50 p-6 rounded-lg">
              <summary className="font-bold text-gray-900 cursor-pointer">
                Czy przysługuje mi odszkodowanie za odwołany lot Ryanair KRK-Londyn?
              </summary>
              <p className="text-gray-700 mt-3">
                <strong>Tak!</strong> KRK-Londyn to trasa <strong>do 1500 km</strong> (~1280 km), więc przysługuje Ci <strong>250 € odszkodowania</strong> przy odwołaniu lotu (jeśli odwołanie było mniej niż 14 dni przed wylotem).
              </p>
            </details>
            ...
            <details className="bg-gray-50 p-6 rounded-lg">
              <summary className="font-bold text-gray-900 cursor-pointer">
                Ile czasu mam na zgłoszenie reklamacji za lot z Krakowa KRK?
              </summary>
              <p className="text-gray-700 mt-3">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-8 rounded-lg my-12">
            <h2 className="text-2xl font-bold mb-4">
              Odwołany lot z Krakowa KRK? Sprawdź swoje odszkodowanie!
            </h2>
          ...
          <section itemScope itemType="https://schema.org/FAQPage" className="hidden">
            <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
              <h3 itemProp="name">Czy przysługuje mi odszkodowanie za odwołany lot Ryanair KRK-Londyn?</h3>
              <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                <div itemProp="text">
                  Tak! KRK-Londyn to trasa do 1500 km (~1280 km), więc przysługuje Ci 250 € odszkodowania przy odwołaniu lotu (jeśli odwołanie było mniej niż 14 dni przed wylotem) według rozporządzenia WE 261/2004.
                </div>
              </div>
            </div>
