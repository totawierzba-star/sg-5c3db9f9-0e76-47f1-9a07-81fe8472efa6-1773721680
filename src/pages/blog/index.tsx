...
import { Plane, Calendar, ArrowRight, Search, Filter } from "lucide-react";
...
export default function BlogIndex() {
  ...
  return (
    <Layout>
      <SEO
        title="Blog – Problem z lotem? Poznaj swoje prawa | ProblemLot.pl"
        description="Kompleksowy przewodnik po prawach pasażerskich. Dowiedz się, kiedy przysługuje Ci odszkodowanie za opóźniony lub odwołany lot."
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-sm font-medium">92 artykuły eksperckie</span>
              </div>
