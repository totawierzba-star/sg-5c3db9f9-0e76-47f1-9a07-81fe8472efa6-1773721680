  ...
  return (
    <Layout>
      <SEO
        ...
        canonical="https://lotproblem.pl/blog/odszkodowanie-lufthansa-polska"
      />
      <script
        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6 mt-12 flex items-center gap-3">
              ...
              4 sposoby odzyskania odszkodowania — porównanie
            </h2>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-slate-100 dark:bg-slate-800">
                    <th className="border border-slate-300 dark:border-slate-700 p-3 text-left">Metoda</th>
                    <th className="border border-slate-300 dark:border-slate-700 p-3 text-left">Skuteczność</th>
                    <th className="border border-slate-300 dark:border-slate-700 p-3 text-left">Czas</th>
                    <th className="border border-slate-300 dark:border-slate-700 p-3 text-left">Koszt</th>
                    <th className="border border-slate-300 dark:border-slate-700 p-3 text-left">Wysiłek</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-slate-300 dark:border-slate-700 p-3">
                      <strong>Samodzielnie</strong>
                    </td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3">~19%</td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3">3-6 miesięcy</td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3 text-green-600 dark:text-green-400">0 zł</td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3 text-red-600 dark:text-red-400">Bardzo wysoki</td>
                  </tr>
                  <tr className="bg-blue-50 dark:bg-blue-950/30">
                    <td className="border border-slate-300 dark:border-slate-700 p-3">
                      <strong>ClaimWinger</strong> ⭐
                    </td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3 text-green-600 dark:text-green-400">
                      <strong>83%</strong>
                    </td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3">4-6 tygodni</td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3">25% prowizji</td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3 text-green-600 dark:text-green-400">Zerowy</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-300 dark:border-slate-700 p-3">
                      <strong>ULC (urząd)</strong>
                    </td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3">~41%</td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3">6-12 miesięcy</td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3 text-green-600 dark:text-green-400">0 zł</td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3">Średni</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-300 dark:border-slate-700 p-3">
                      <strong>Sąd</strong>
                    </td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3">~92%</td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3">12-24 miesiące</td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3 text-red-600 dark:text-red-400">1000-3000 zł</td>
                    <td className="border border-slate-300 dark:border-slate-700 p-3 text-red-600 dark:text-red-400">Bardzo wysoki</td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 border-l-4 border-blue-600 dark:border-blue-400 p-6 my-8">
              <p className="text-slate-800 dark:text-slate-200 font-medium mb-2">
                💡 <strong>Dlaczego ClaimWinger to najlepsza opcja?</strong>
              </p>
              <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                <li>• <strong>83% skuteczności</strong> — wygrywają 8 z 10 spraw przeciwko Lufthansa</li>
                <li>• <strong>Zero ryzyka</strong> — płacisz tylko jeśli wygrasz (25% prowizji od kwoty odszkodowania)</li>
                <li>• <strong>Szybko</strong> — średnio 4-6 tygodni vs. 3-6 miesięcy samodzielnie</li>
                <li>• <strong>Zero wysiłku</strong> — oni zajmują się wszystkim, Ty czekasz na przelew</li>
                <li>• <strong>Prawnicy specjaliści</strong> — znają wszystkie kruczki Lufthansa i sądów</li>
              </ul>
            </div>
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-700 dark:text-slate-300">
                      Anna złożyła wniosek samodzielnie do Lufthansa. Otrzymała odpowiedź: <em>"Opóźnienie było spowodowane nieoczekiwaną usterkątechniczną – nadzwyczajna okoliczność. Odszkodowanie nie przysługuje."</em>
                    </p>
