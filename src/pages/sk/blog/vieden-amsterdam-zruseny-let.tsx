...
const articleUrl = "https://problemlot.com/sk/blog/vieden-amsterdam-zruseny-let";
const delayedFlightHref =
  "https://claimwinger.com/sk/meskajuci-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=vienna_amsterdam_cancelled";
const cancelledFlightHref =
  "https://claimwinger.com/sk/zruseny-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=vienna_amsterdam_cancelled";
const claimWingerHomeHref =
  "https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=vienna_amsterdam_cancelled";
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Pri samostatnom lete Viedeň – Amsterdam ide zvyčajne o pásmo do 1 500 km, takže kompenzácia býva 250 €. Osobitne však stále máte aj právo na refundáciu alebo presmerovanie.",
  },
  {
...
export default function ViedenAmsterdamZrusenyLetPage() {
  return (
    <LayoutSk>
      <SEO
        title="Viedeň – Amsterdam zrušený let: odškodnenie, refundácia a čo rozhoduje"
        description="Zrušili vám let z Viedne do Amsterdamu? Zistite, kedy vzniká nárok na odškodnenie, kedy ide typicky o 250 € a ako sa líši refundácia od kompenzácie."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Viedeň – Amsterdam zrušený let: odškodnenie, refundácia a čo rozhoduje",
            description:
              "Praktický sprievodca pre cestujúcich pri zrušenom lete z Viedne do Amsterdamu vrátane kompenzácie, refundácie a presmerovania podľa EU261.",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Viedeň – Amsterdam zrušený let",
                item: articleUrl,
              },
            ],
          }),
      ...
      <article className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-cyan-50 dark:from-gray-950 dark:via-gray-900 dark:to-slate-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span>/</span>
            <span>Viedeň – Amsterdam zrušený let</span>
          </div>
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-cyan-100 px-4 py-2 text-sm font-medium text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-300">
              Route content pre VIE a AMS
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Viedeň – Amsterdam zrušený let: mám nárok na odškodnenie?
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Pri zrušenom lete z <strong>Viedne do Amsterdamu</strong> netreba pozerať len na to, či
              vám vrátia cenu letenky. Ak vás aerolínka informovala neskoro, neponúkla primerané
          ...
          <section className="mb-10">
            <Card className="border-cyan-200 bg-gradient-to-br from-cyan-600 to-sky-700 p-8 text-white shadow-xl dark:border-cyan-800">
              ...
              <div className="space-y-3 text-base leading-7 text-cyan-50">
                <p>
                  <strong>Áno, často áno.</strong> Let z Viedne do Amsterdamu odlieta z EÚ a končí v
                  EÚ, preto sa naň pravidlá EU261 vzťahujú veľmi priamočiaro.
                </p>
                <p>
          ...
          <ClaimWingerSkSection
            className="mb-12"
            title="Zrušili vám let Viedeň – Amsterdam?"
            ...
            ctaHref="https://claimwinger.com/sk/zruseny-let?utm_source=problemlot-sk&utm_medium=embedded_cta&utm_campaign=vienna_amsterdam_cancelled"
            ...
            placement="sk_blog_vienna_amsterdam_cancelled_embed"
          />
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {[
                ...
                "Amsterdam bol konečný cieľ, alebo šlo o jednu spoločnú rezerváciu",
              ].map((item) => (
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg max-w-none text-slate-700 dark:prose-invert dark:text-slate-300">
              ...
              <p>
                Pri trase Viedeň – Amsterdam je dôležité, že let odlieta z EÚ a končí v EÚ. Preto sa
                naň európske pravidlá vzťahujú veľmi priamočiaro a bez osobitných hraničných výnimiek.
              </p>
            </div>
          </section>
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_vienna_amsterdam_cancelled_final_cta_cancelled",
                        cancelledFlightHref
                      )
                    }
                  >
                ...
                <Button asChild size="lg" variant="outline">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_vienna_amsterdam_cancelled_final_cta_delay",
                        delayedFlightHref
                      )
                    }
                  >
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <a
                  ...
                  onClick={() =>
                    trackClaimClick(
                      "sk_vienna_amsterdam_cancelled_related_home",
                      claimWingerHomeHref
                    )
                  }
                  className="font-semibold text-blue-600 underline underline-offset-4"
