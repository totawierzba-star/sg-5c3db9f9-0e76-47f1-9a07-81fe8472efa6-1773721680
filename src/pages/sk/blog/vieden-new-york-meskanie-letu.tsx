...
const articleUrl = "https://problemlot.com/sk/blog/vieden-new-york-meskanie-letu";
const delayedFlightHref =
  "https://claimwinger.com/sk/meskajuci-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=vienna_new_york_delay";
const cancelledFlightHref =
  "https://claimwinger.com/sk/zruseny-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=vienna_new_york_delay";
const claimWingerHomeHref =
  "https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=vienna_new_york_delay";
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Pri samostatnom lete Viedeň – New York ide zvyčajne o dlhú trasu nad 3 500 km, takže pri splnení podmienok býva typická kompenzácia 600 €. Ak však New York nebol konečný cieľ a cesta pokračovala ďalej na jednej rezervácii, rozhodovať môže až konečná destinácia celej cesty.",
  },
  {
...
export default function ViedenNewYorkMeskanieLetuPage() {
  return (
    <LayoutSk>
      <SEO
        title="Viedeň – New York meškanie letu: odškodnenie, výška nároku a čo rozhoduje"
        description="Meškal vám let z Viedne do New Yorku? Zistite, kedy vzniká nárok na odškodnenie, prečo býva na tejto trase často 600 € a prečo rozhoduje meškanie v cieli."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline:
              "Viedeň – New York meškanie letu: odškodnenie, výška nároku a čo rozhoduje",
            description:
              "Praktický sprievodca pre cestujúcich pri meškaní letu z Viedne do New Yorku vrátane výšky nároku a pravidiel EU261.",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Viedeň – New York meškanie letu",
                item: articleUrl,
              },
            ],
          }),
      ...
      <article className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50 dark:from-gray-950 dark:via-gray-900 dark:to-slate-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span>/</span>
            <span>Viedeň – New York meškanie letu</span>
          </div>
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-indigo-100 px-4 py-2 text-sm font-medium text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300">
              Route content pre VIE a New York
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Viedeň – New York meškanie letu: mám nárok na odškodnenie?
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Pri bežnom lete z <strong>Viedne do New Yorku</strong> býva odpoveď často priaznivá:
          ...
          <section className="mb-10">
            <Card className="border-indigo-200 bg-gradient-to-br from-indigo-600 to-sky-700 p-8 text-white shadow-xl dark:border-indigo-800">
              <h2 className="mb-4 text-2xl font-bold">Krátka odpoveď</h2>
              <div className="space-y-3 text-base leading-7 text-indigo-50">
                <p>
                  <strong>Áno, často áno.</strong> Let z Viedne do New Yorku odlieta z EÚ, takže
                ...
                <p>
                  Ak však New York nebol konečný cieľ, ale len časť jednej rezervácie ďalej,
          ...
          <ClaimWingerSkSection
            className="mb-12"
            title="Meškal vám let Viedeň – New York?"
            ...
            ctaHref="https://claimwinger.com/sk/meskajuci-let?utm_source=problemlot-sk&utm_medium=embedded_cta&utm_campaign=vienna_new_york_delay"
            ...
            placement="sk_blog_vienna_new_york_delay_embed"
          />
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Hoci New York leží mimo EÚ, pri odlete z Viedne sa ochrana EU261 na takúto cestu
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri bežnom priamom lete Viedeň – New York ide typicky o dlhú trasu nad 3 500 km,
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="border-green-200 p-6 dark:border-green-800">
                <h3 className="mb-2 text-xl font-semibold text-slate-900 dark:text-white">
                  Priamy let Viedeň – New York
                </h3>
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak ste leteli point-to-point a prišli ste do New Yorku s meškaním aspoň 3 hodiny,
              ...
              <Card className="border-amber-200 p-6 dark:border-amber-800">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak New York nebol konečný cieľ a cesta pokračovala ďalej na jednej rezervácii,
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {[
                ...
                "New York bol samostatný let alebo súčasť jednej rezervácie",
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri letoch cez Atlantik aerolínky často argumentujú počasím, obmedzeniami riadenia
                  letovej prevádzky alebo inými mimoriadnymi okolnosťami. Takéto tvrdenie však musí
                  vedieť aj konkrétne preukázať.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak New York bol len prestupný bod a ďalší let ste mali na samostatnej letenke,
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg max-w-none text-slate-700 dark:prose-invert dark:text-slate-300">
              <p>
                ...
                Viedne do New Yorku je rozhodujúce to, že cesta začína v EÚ.
              </p>
              <p>
                Pri tejto trase je preto kľúčové rozlíšiť, či išlo o samostatný long-haulový let do
                New Yorku, alebo o časť širšej cesty na jednej rezervácii ďalej.
              </p>
            </div>
          </section>
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_vienna_new_york_delay_final_cta_delay",
                        delayedFlightHref
                      )
                    }
                  >
                ...
                <Button asChild size="lg" variant="outline">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_vienna_new_york_delay_final_cta_cancelled",
                        cancelledFlightHref
                      )
                    }
                  >
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <a
                  ...
                  onClick={() =>
                    trackClaimClick(
                      "sk_vienna_new_york_delay_related_home",
                      claimWingerHomeHref
                    )
                  }
                  className="font-semibold text-blue-600 underline underline-offset-4"
