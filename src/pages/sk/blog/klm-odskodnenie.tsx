...
const articleUrl = "https://problemlot.com/sk/blog/klm-odskodnenie";
const delayedFlightHref =
  "https://claimwinger.com/sk/meskajuci-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=klm_compensation";
const cancelledFlightHref =
  "https://claimwinger.com/sk/zruseny-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=klm_compensation";
const claimWingerHomeHref =
  "https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=klm_compensation";
...
const faqItems = [
  ...
  {
    question: "Koľko môžem dostať od KLM?",
    answer:
...
export default function KlmOdskodneniePage() {
  return (
    <LayoutSk>
      <SEO
        title="KLM odškodnenie: kedy vzniká nárok a koľko môžete dostať"
        description="Meškal vám, zrušili alebo výrazne presunuli let KLM? Zistite, kedy vzniká nárok na odškodnenie, kedy ide o 250 €, 400 € alebo 600 € a čo pri EU261 rozhoduje."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "KLM odškodnenie: kedy vzniká nárok a koľko môžete dostať",
            description:
              "Praktický sprievodca pre cestujúcich pri problémoch s letom KLM vrátane výšky nároku, pravidiel EU261 a významu európskeho dopravcu.",
        ...
        <div className="mx-auto max-w-4xl px-4 py-12">
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-orange-100 px-4 py-2 text-sm font-medium text-orange-700 dark:bg-orange-900/30 dark:text-orange-300">
              Airline content pre KLM
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              KLM odškodnenie: kedy vzniká nárok?
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Ak ste leteli s <strong>KLM</strong> a nastal problém, odpoveď býva často priaznivá.
          ...
          <section className="mb-10">
            <Card className="border-orange-200 bg-gradient-to-br from-orange-600 to-amber-700 p-8 text-white shadow-xl dark:border-orange-800">
              ...
              <div className="space-y-3 text-base leading-7 text-orange-50">
                <p>
                  <strong>Áno, často áno.</strong> KLM je európska aerolinka, takže pri mnohých
                ...
                <p>
                  ...
                  do konečnej destinácie a či KLM naozaj vie preukázať mimoriadne okolnosti.
                </p>
              </div>
            </Card>
          </section>
          ...
          <ClaimWingerSkSection
            className="mb-12"
            title="Riešite meškanie alebo zrušenie letu KLM?"
            ...
            ctaHref="https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=embedded_cta&utm_campaign=klm_compensation"
            ...
            placement="sk_blog_klm_compensation_embed"
          />

          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Prečo je pri KLM dôležité, že ide o dopravcu z EÚ
            </h2>
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri letoch z tretích krajín späť do EÚ býva fakt, že KLM je dopravca z EÚ, často
                  veľmi dôležitý pre to, či sa EU261 vôbec uplatní.
                </p>
              </Card>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {[
                ...
                "máte rezerváciu, číslo letu a komunikáciu od KLM",
                "KLM nevie presvedčivo doložiť mimoriadne okolnosti",
          ...
          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Čo pri KLM najčastejšie komplikuje posúdenie
            </h2>
            <div className="grid gap-4">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
                  Prestup cez Amsterdam
                </h3>
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri KLM býva veľmi častý scenár, že Amsterdam je len prestupný bod. V takom prípade
                  môže byť rozhodujúca až konečná destinácia celej rezervácie, nie len samotný prílet
                  do AMS.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri letoch predaných pod značkou KLM, ale operovaných partnerom, môže byť dôležité
                  presne určiť, kto bol skutočný operujúci dopravca.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg max-w-none text-slate-700 dark:prose-invert dark:text-slate-300">
              ...
              <p>
                Pri KLM je navyše dôležité rozumieť tomu, že ide o európskeho dopravcu. To býva
                mimoriadne praktické pri letoch späť do EÚ z tretích krajín a pri častých
                prestupových itinerároch cez Amsterdam.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            <Card className="border-blue-200 bg-blue-50 p-8 dark:border-blue-800 dark:bg-blue-950/20">
              ...
              <p className="mb-6 text-base leading-7 text-slate-700 dark:text-slate-300">
                Pri KLM má veľký zmysel rýchlo oddeliť silný prípad 250 €, 400 € alebo 600 € od
                zložitejšej situácie s prestupom cez Amsterdam, partnerom, codeshare alebo tvrdenými
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick("sk_klm_compensation_final_cta_delay", delayedFlightHref)
                    }
                  >
                ...
                <Button asChild size="lg" variant="outline">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_klm_compensation_final_cta_cancelled",
                        cancelledFlightHref
                      )
                    }
                  >
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() =>
                    trackClaimClick("sk_klm_compensation_related_home", claimWingerHomeHref)
                  }
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak KLM bol len časťou jednej cesty a problém sa prejavil ďalej v itinerári.
                </p>
                <Link
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak riešite trasu cez holandský hub a chcete užší route-specific kontext.
                </p>
                <Link
