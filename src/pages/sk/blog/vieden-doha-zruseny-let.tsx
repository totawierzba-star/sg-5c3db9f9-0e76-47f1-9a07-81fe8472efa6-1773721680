...
const articleUrl = "https://problemlot.com/sk/blog/vieden-doha-zruseny-let";
const delayedFlightHref =
  "https://claimwinger.com/sk/meskajuci-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=vienna_doha_cancelled";
const cancelledFlightHref =
  "https://claimwinger.com/sk/zruseny-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=vienna_doha_cancelled";
const claimWingerHomeHref =
  "https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=vienna_doha_cancelled";
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Pri samostatnom lete Viedeň – Doha ide zvyčajne o dlhú trasu nad 3 500 km, takže kompenzácia býva 600 €. Osobitne však stále máte aj právo na refundáciu alebo presmerovanie.",
  },
  {
...
export default function ViedenDohaZrusenyLetPage() {
  return (
    <LayoutSk>
      <SEO
        title="Viedeň – Doha zrušený let: odškodnenie, refundácia a čo rozhoduje"
        description="Zrušili vám let z Viedne do Dohy? Zistite, kedy vzniká nárok na odškodnenie, kedy ide typicky o 600 € a ako sa líši refundácia od kompenzácie."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Viedeň – Doha zrušený let: odškodnenie, refundácia a čo rozhoduje",
            description:
              "Praktický sprievodca pre cestujúcich pri zrušenom lete z Viedne do Dohy vrátane kompenzácie, refundácie a presmerovania podľa EU261.",
      ...
      <article className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-rose-50 dark:from-gray-950 dark:via-gray-900 dark:to-slate-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span>/</span>
            <span>Viedeň – Doha zrušený let</span>
          </div>
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-rose-100 px-4 py-2 text-sm font-medium text-rose-700 dark:bg-rose-900/30 dark:text-rose-300">
              Route content pre VIE a Doha
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Viedeň – Doha zrušený let: mám nárok na odškodnenie?
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Pri zrušenom lete z <strong>Viedne do Dohy</strong> netreba pozerať len na to, či vám
          ...
          <section className="mb-10">
            <Card className="border-rose-200 bg-gradient-to-br from-rose-600 to-pink-700 p-8 text-white shadow-xl dark:border-rose-800">
              ...
              <div className="space-y-3 text-base leading-7 text-rose-50">
                <p>
                  <strong>Áno, často áno.</strong> Let z Viedne do Dohy odlieta z EÚ, preto sa naň
          ...
          <ClaimWingerSkSection
            className="mb-12"
            title="Zrušili vám let Viedeň – Doha?"
            ...
            ctaHref="https://claimwinger.com/sk/zruseny-let?utm_source=problemlot-sk&utm_medium=embedded_cta&utm_campaign=vienna_doha_cancelled"
            ...
            placement="sk_blog_vienna_doha_cancelled_embed"
          />
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {[
                ...
                "náhradný let vás dostal do Dohy výrazne neskôr než pôvodný plán",
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri letoch do Dohy aerolínky často argumentujú počasím, obmedzeniami riadenia
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak Doha nebola konečný cieľ a cesta pokračovala ďalej na jednej rezervácii, pri
                  hodnotení kompenzácie môže rozhodovať až výsledok v konečnej destinácii celej
                  cesty.
                </p>
              </Card>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg max-w-none text-slate-700 dark:prose-invert dark:text-slate-300">
              ...
              <p>
                Pri trase Viedeň – Doha je rozhodujúce najmä to, že cesta začína v EÚ. To je dôvod,
                prečo EU261 ostáva relevantné aj pri lete do Kataru.
              </p>
            </div>
          </section>
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_vienna_doha_cancelled_final_cta_cancelled",
                        cancelledFlightHref
                      )
                    }
                  >
                ...
                <Button asChild size="lg" variant="outline">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_vienna_doha_cancelled_final_cta_delay",
                        delayedFlightHref
                      )
                    }
                  >
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak Doha nebola konečný cieľ a cesta pokračovala ďalej na jednej rezervácii.
                </p>
                <Link
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <a
                  ...
                  onClick={() =>
                    trackClaimClick(
                      "sk_vienna_doha_cancelled_related_home",
                      claimWingerHomeHref
                    )
                  }
                  className="font-semibold text-blue-600 underline underline-offset-4"
