...
const articleUrl = "https://problemlot.com/sk/blog/transavia-odskodnenie";
const delayedFlightHref =
  "https://claimwinger.com/sk/meskajuci-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=transavia_compensation";
const cancelledFlightHref =
  "https://claimwinger.com/sk/zruseny-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=transavia_compensation";
const claimWingerHomeHref =
  "https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=transavia_compensation";
...
const faqItems = [
  ...
  {
    question: "Koľko môžem dostať od Transavie?",
    answer:
...
export default function TransaviaOdskodneniePage() {
  return (
    <LayoutSk>
      <SEO
        title="Transavia odškodnenie: kedy vzniká nárok a koľko môžete dostať"
        description="Meškal vám, zrušili alebo výrazne presunuli let Transavia? Zistite, kedy vzniká nárok na odškodnenie, kedy ide o 250 €, 400 € alebo 600 € a čo pri EU261 rozhoduje."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Transavia odškodnenie: kedy vzniká nárok a koľko môžete dostať",
            description:
              "Praktický sprievodca pre cestujúcich pri problémoch s letom Transavia vrátane výšky nároku, pravidiel EU261 a špecifík nízkonákladovej dovolenkovej prevádzky.",
      ...
      <article className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-cyan-50 dark:from-gray-950 dark:via-gray-900 dark:to-slate-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span>/</span>
            <span>Transavia odškodnenie</span>
          </div>
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-cyan-100 px-4 py-2 text-sm font-medium text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-300">
              Airline content pre Transavia
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Transavia odškodnenie: kedy vzniká nárok?
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Ak ste leteli s <strong>Transavia</strong> a nastal problém, odpoveď býva často
          ...
          <section className="mb-10">
            <Card className="border-cyan-200 bg-gradient-to-br from-cyan-600 to-sky-700 p-8 text-white shadow-xl dark:border-cyan-800">
              ...
              <div className="space-y-3 text-base leading-7 text-cyan-50">
                <p>
                  <strong>Áno, často áno.</strong> Transavia je európska aerolinka, takže pri mnohých
                ...
                <p>
                  ...
                  do konečnej destinácie a či Transavia naozaj vie preukázať mimoriadne okolnosti.
                </p>
              </div>
            </Card>
          </section>
          ...
          <ClaimWingerSkSection
            className="mb-12"
            title="Riešite meškanie alebo zrušenie letu Transavia?"
            ...
            ctaHref="https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=embedded_cta&utm_campaign=transavia_compensation"
            ...
            placement="sk_blog_transavia_compensation_embed"
          />

          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Prečo je pri Transavii dôležité, že ide o dopravcu z EÚ
            </h2>
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri letoch z tretích krajín späť do EÚ býva fakt, že Transavia je dopravca z EÚ,
                  dôležitý pre to, či sa EU261 vôbec uplatní.
                </p>
              </Card>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {[
                ...
                "máte rezerváciu, číslo letu a komunikáciu od Transavie",
                "Transavia nevie presvedčivo doložiť mimoriadne okolnosti",
          ...
          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Čo pri Transavii najčastejšie komplikuje posúdenie
            </h2>
            <div className="grid gap-4">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
                  Leisure a sezónna prevádzka
                </h3>
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri Transavii sa často riešia dovolenkové a sezónne trasy. To však neznamená, že
                  nárok je automaticky slabší. Stále rozhoduje konečná destinácia, nie len samotný
                  charakter cesty.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
                  Holandsko a Francúzsko ako hlavné základne
                </h3>
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri Transavii sa často objavujú lety cez holandské alebo francúzske základne.
                  Prakticky to znamená, že treba pozorne čítať konkrétnu trasu, letový plán a to, či
                  išlo o samostatný dovolenkový let alebo o súčasť širšieho itinerára.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg max-w-none text-slate-700 dark:prose-invert dark:text-slate-300">
              ...
              <p>
                Pri Transavii je zároveň dôležité vnímať jej typickú nízkonákladovú a dovolenkovú
                prevádzku. Nízka cena letenky ani rekreačný charakter trasy samy osebe nárok nevylučujú.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            <Card className="border-blue-200 bg-blue-50 p-8 dark:border-blue-800 dark:bg-blue-950/20">
              ...
              <p className="mb-6 text-base leading-7 text-slate-700 dark:text-slate-300">
                Pri Transavii má veľký zmysel rýchlo oddeliť silný prípad 250 €, 400 € alebo 600 €
                od zložitejšej situácie so sezónnou trasou, partnerom, zdieľaným kódom alebo
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_transavia_compensation_final_cta_delay",
                        delayedFlightHref
                      )
                    }
                  >
                ...
                <Button asChild size="lg" variant="outline">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_transavia_compensation_final_cta_cancelled",
                        cancelledFlightHref
                      )
                    }
                  >
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() =>
                    trackClaimClick("sk_transavia_compensation_related_home", claimWingerHomeHref)
                  }
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak Transavia bola len časťou jednej cesty a problém sa prejavil ďalej v itinerári.
                </p>
                <Link
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak riešite užší trasovo špecifický kontext spojený s holandským uzlom.
                </p>
                <Link
