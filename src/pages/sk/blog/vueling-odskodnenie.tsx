...
const articleUrl = "https://problemlot.com/sk/blog/vueling-odskodnenie";
const delayedFlightHref =
  "https://claimwinger.com/sk/meskajuci-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=vueling_compensation";
const cancelledFlightHref =
  "https://claimwinger.com/sk/zruseny-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=vueling_compensation";
const claimWingerHomeHref =
  "https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=vueling_compensation";
...
const faqItems = [
  ...
  {
    question: "Koľko môžem dostať od Vuelingu?",
    answer:
...
export default function VuelingOdskodneniePage() {
  return (
    <LayoutSk>
      <SEO
        title="Vueling odškodnenie: kedy vzniká nárok a koľko môžete dostať"
        description="Meškal vám, zrušili alebo výrazne presunuli let Vueling? Zistite, kedy vzniká nárok na odškodnenie, kedy ide o 250 €, 400 € alebo 600 € a čo pri EU261 rozhoduje."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Vueling odškodnenie: kedy vzniká nárok a koľko môžete dostať",
            description:
              "Praktický sprievodca pre cestujúcich pri problémoch s letom Vueling vrátane výšky nároku, pravidiel EU261 a špecifík low-cost prevádzky v rámci EÚ.",
        ...
        <div className="mx-auto max-w-4xl px-4 py-12">
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-amber-100 px-4 py-2 text-sm font-medium text-amber-700 dark:bg-amber-900/30 dark:text-amber-300">
              Airline content pre Vueling
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Vueling odškodnenie: kedy vzniká nárok?
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Ak ste leteli s <strong>Vueling</strong> a nastal problém, odpoveď býva často priaznivá.
          ...
          <section className="mb-10">
            <Card className="border-amber-200 bg-gradient-to-br from-amber-500 to-orange-600 p-8 text-white shadow-xl dark:border-amber-800">
              ...
              <div className="space-y-3 text-base leading-7 text-amber-50">
                <p>
                  <strong>Áno, často áno.</strong> Vueling je európska aerolinka, takže pri mnohých
                ...
                <p>
                  ...
                  do konečnej destinácie a či Vueling naozaj vie preukázať mimoriadne okolnosti.
                </p>
              </div>
            </Card>
          </section>
          ...
          <ClaimWingerSkSection
            className="mb-12"
            title="Riešite meškanie alebo zrušenie letu Vueling?"
            ...
            ctaHref="https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=embedded_cta&utm_campaign=vueling_compensation"
            ...
            placement="sk_blog_vueling_compensation_embed"
          />

          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Prečo je pri Vuelingu dôležité, že ide o dopravcu z EÚ
            </h2>
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri letoch z tretích krajín späť do EÚ býva fakt, že Vueling je dopravca z EÚ,
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {[
                ...
                "máte rezerváciu, číslo letu a komunikáciu od Vuelingu",
                "Vueling nevie presvedčivo doložiť mimoriadne okolnosti",
          ...
          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Čo pri Vuelingu najčastejšie komplikuje posúdenie
            </h2>
            <div className="grid gap-4">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
                  Krátke trasy a priame spojenia
                </h3>
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri Vuelingu ide často o kratšie priame spojenia. To však neznamená, že nárok je
                  automaticky jednoduchý. Aj tu rozhoduje konečná destinácia, nie len samotný odlet
                  alebo meškanie pri nástupe na bránu.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
                  Barcelona ako častý prevádzkový uzol
                </h3>
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri Vuelingu sa veľmi často objavuje Barcelona ako kľúčový uzol. Ak bola len
                  prestupným bodom v jednej rezervácii, môže byť rozhodujúca až konečná destinácia
                  celej cesty.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg max-w-none text-slate-700 dark:prose-invert dark:text-slate-300">
              ...
              <p>
                Pri Vuelingu je zároveň dôležité vnímať jeho typickú low-cost prevádzku v rámci
                Európy. Nízka cena letenky ani model priamych spojení samy osebe nárok nevylučujú.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            <Card className="border-blue-200 bg-blue-50 p-8 dark:border-blue-800 dark:bg-blue-950/20">
              ...
              <p className="mb-6 text-base leading-7 text-slate-700 dark:text-slate-300">
                Pri Vuelingu má veľký zmysel rýchlo oddeliť silný prípad 250 €, 400 € alebo 600 € od
                zložitejšej situácie s prestupom cez Španielsko, partnerom, zdieľaným kódom alebo
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick("sk_vueling_compensation_final_cta_delay", delayedFlightHref)
                    }
                  >
                ...
                <Button asChild size="lg" variant="outline">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_vueling_compensation_final_cta_cancelled",
                        cancelledFlightHref
                      )
                    }
                  >
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() =>
                    trackClaimClick("sk_vueling_compensation_related_home", claimWingerHomeHref)
                  }
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak Vueling bol len časťou jednej cesty a problém sa prejavil ďalej v itinerári.
                </p>
                <Link
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak riešite užší trasovo špecifický kontext kratšieho európskeho letu.
                </p>
                <Link
