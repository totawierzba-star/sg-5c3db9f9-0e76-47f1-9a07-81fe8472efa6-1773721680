...
const articleUrl = "https://problemlot.com/sk/blog/tap-air-portugal-odskodnenie";
const delayedFlightHref =
  "https://claimwinger.com/sk/meskajuci-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=tap_air_portugal_compensation";
const cancelledFlightHref =
  "https://claimwinger.com/sk/zruseny-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=tap_air_portugal_compensation";
const claimWingerHomeHref =
  "https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=tap_air_portugal_compensation";
...
const faqItems = [
  ...
  {
    question: "Koľko môžem dostať od TAP Air Portugal?",
    answer:
...
export default function TapAirPortugalOdskodneniePage() {
  return (
    <LayoutSk>
      <SEO
        title="TAP Air Portugal odškodnenie: kedy vzniká nárok a koľko môžete dostať"
        description="Meškal vám, zrušili alebo výrazne presunuli let TAP Air Portugal? Zistite, kedy vzniká nárok na odškodnenie, kedy ide o 250 €, 400 € alebo 600 € a čo pri EU261 rozhoduje."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "TAP Air Portugal odškodnenie: kedy vzniká nárok a koľko môžete dostať",
            description:
              "Praktický sprievodca pre cestujúcich pri problémoch s letom TAP Air Portugal vrátane výšky nároku, pravidiel EU261 a významu európskeho dopravcu.",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "TAP Air Portugal odškodnenie",
                item: articleUrl,
              },
            ],
          }),
      ...
      <article className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 dark:from-gray-950 dark:via-gray-900 dark:to-slate-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span>/</span>
            <span>TAP Air Portugal odškodnenie</span>
          </div>
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-emerald-100 px-4 py-2 text-sm font-medium text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300">
              Airline content pre TAP Air Portugal
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              TAP Air Portugal odškodnenie: kedy vzniká nárok?
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Ak ste leteli s <strong>TAP Air Portugal</strong> a nastal problém, odpoveď býva často
          ...
          <section className="mb-10">
            <Card className="border-emerald-200 bg-gradient-to-br from-emerald-600 to-teal-700 p-8 text-white shadow-xl dark:border-emerald-800">
              ...
              <div className="space-y-3 text-base leading-7 text-emerald-50">
                <p>
                  <strong>Áno, často áno.</strong> TAP Air Portugal je európska aerolinka, takže pri
                  mnohých letoch v rámci EÚ, z EÚ a aj pri časti letov späť do EÚ môže byť ochrana
                  EU261 veľmi silná.
                </p>
                <p>
                ...
                <p>
                  ...
                  do konečnej destinácie a či TAP Air Portugal naozaj vie preukázať mimoriadne
                  okolnosti.
                </p>
              </div>
            </Card>
          ...
          <ClaimWingerSkSection
            className="mb-12"
            title="Riešite meškanie alebo zrušenie letu TAP Air Portugal?"
            ...
            ctaHref="https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=embedded_cta&utm_campaign=tap_air_portugal_compensation"
            ...
            placement="sk_blog_tap_air_portugal_compensation_embed"
          />

          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Prečo je pri TAP Air Portugal dôležité, že ide o dopravcu z EÚ
            </h2>
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri letoch z tretích krajín späť do EÚ býva fakt, že TAP Air Portugal je dopravca
                  z EÚ, často veľmi dôležitý pre to, či sa EU261 vôbec uplatní.
                </p>
              </Card>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {[
                ...
                "máte rezerváciu, číslo letu a komunikáciu od TAP Air Portugal",
                "TAP nevie presvedčivo doložiť mimoriadne okolnosti",
          ...
          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Čo pri TAP Air Portugal najčastejšie komplikuje posúdenie
            </h2>
            <div className="grid gap-4">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
                  Prestup cez Lisabon alebo Porto
                </h3>
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri TAP Air Portugal býva častý scenár, že Portugalsko je len prestupný bod. V
                  takom prípade môže byť rozhodujúca až konečná destinácia celej rezervácie, nie len
                  samotný prílet do Lisabonu alebo Porta.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
                  Lety do Brazílie a späť
                </h3>
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri TAP Air Portugal sa často riešia aj diaľkové lety medzi Európou a Brazíliou.
                  Práve tam vie byť dôležité, že ide o dopravcu z EÚ, najmä pri návrate z tretích
                  krajín späť do Únie.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg max-w-none text-slate-700 dark:prose-invert dark:text-slate-300">
              ...
              <p>
                Pri TAP Air Portugal je navyše dôležité rozumieť tomu, že ide o európskeho dopravcu.
                To býva mimoriadne praktické pri letoch späť do EÚ z tretích krajín a pri častých
                prestupových itinerároch cez Lisabon.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            <Card className="border-blue-200 bg-blue-50 p-8 dark:border-blue-800 dark:bg-blue-950/20">
              ...
              <p className="mb-6 text-base leading-7 text-slate-700 dark:text-slate-300">
                Pri TAP Air Portugal má veľký zmysel rýchlo oddeliť silný prípad 250 €, 400 € alebo
                600 € od zložitejšej situácie s prestupom cez Portugalsko, partnerom, letom v
                zdieľanom kóde alebo tvrdenými mimoriadnymi okolnosťami.
              </p>
              <div className="flex flex-wrap gap-3">
                <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_tap_air_portugal_compensation_final_cta_delay",
                        delayedFlightHref
                      )
                    }
                  >
                ...
                <Button asChild size="lg" variant="outline">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_tap_air_portugal_compensation_final_cta_cancelled",
                        cancelledFlightHref
                      )
                    }
                  >
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <a
                  ...
                  onClick={() =>
                    trackClaimClick(
                      "sk_tap_air_portugal_compensation_related_home",
                      claimWingerHomeHref
                    )
                  }
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak TAP bol len časťou jednej cesty a problém sa prejavil ďalej v itinerári.
                </p>
                <Link
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-3 text-lg font-semibold text-slate-900 dark:text-white">
                  Viedeň – Dubaj zrušený let
                </h3>
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak riešite širší diaľkový kontext a chcete trasovo špecifický príklad.
                </p>
                <Link
                  href="/sk/blog/vieden-dubaj-zruseny-let"
                  className="font-semibold text-blue-600 underline underline-offset-4"
                >
