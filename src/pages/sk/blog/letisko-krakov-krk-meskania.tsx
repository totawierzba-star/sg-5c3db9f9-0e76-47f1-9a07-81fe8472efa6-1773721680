...
const articleUrl = "https://problemlot.com/sk/blog/letisko-krakov-krk-meskania";
const delayedFlightHref =
  "https://claimwinger.com/sk/meskajuci-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=krakow_airport_delays";
const cancelledFlightHref =
  "https://claimwinger.com/sk/zruseny-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=krakow_airport_delays";
const claimWingerHomeHref =
  "https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=krakow_airport_delays";
...
const faqItems = [
  ...
  {
    question: "Počíta sa meškanie odletu z Krakova alebo príchod do cieľa?",
    answer:
      "Pri kompenzácii sa kľúčovo sleduje meškanie pri príchode do konečnej destinácie, nie len to, o koľko neskôr lietadlo odletelo z Krakova.",
  },
  {
    question: "Čo ak bol problém na KRK spôsobený prevádzkou letiska?",
    answer:
...
export default function LetiskoKrakovKrkMeskaniaPage() {
  return (
    <LayoutSk>
      <SEO
        title="Letisko Krakov (KRK) meškania: práva pasažiera, odškodnenie a čo rozhoduje"
        description="Meškal vám, zrušili alebo výrazne presunuli let z letiska Krakov (KRK)? Zistite, kedy vzniká nárok na odškodnenie, čo pri EU261 rozhoduje a prečo nestačí pozerať len na samotné letisko."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline:
              "Letisko Krakov (KRK) meškania: práva pasažiera, odškodnenie a čo rozhoduje",
            description:
              "Praktický sprievodca pre cestujúcich pri meškaní alebo zrušení letu na letisku Krakov vrátane významu konečnej destinácie, rozsahu EU261 a citlivejších prípadov spojených s prevádzkou letiska.",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Letisko Krakov (KRK) meškania",
                item: articleUrl,
              },
            ],
          }),
      ...
      <article className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-rose-50 dark:from-gray-950 dark:via-gray-900 dark:to-slate-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span>/</span>
            <span>Letisko Krakov (KRK) meškania</span>
          </div>
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-rose-100 px-4 py-2 text-sm font-medium text-rose-700 dark:bg-rose-900/30 dark:text-rose-300">
              Airport content pre Krakov Jana Pavla II (KRK)
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Letisko Krakov (KRK): čo robiť pri meškaní alebo zrušení letu?
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Ak riešite problém na <strong>letisku Krakov (KRK)</strong>, dôležité je nepozerať len
          ...
          <section className="mb-10">
            <Card className="border-rose-200 bg-gradient-to-br from-rose-600 to-pink-700 p-8 text-white shadow-xl dark:border-rose-800">
              ...
              <div className="space-y-3 text-base leading-7 text-rose-50">
                <p>
                  <strong>Áno, často áno.</strong> Ak váš let z Krakova meškal alebo bol zrušený,
                  nárok na kompenzáciu môže vzniknúť. Samotné letisko KRK však nestačí. Rozhoduje
                ...
                <p>
                  Pri letisku Krakov bývajú prakticky dôležité tak priame low-cost lety, ako aj
                  spojenia využívané cestujúcimi z južného Poľska a časti Slovenska. Samotný airport
                  však nikdy nie je jediným kritériom.
                </p>
              </div>
            </Card>
          </section>
          ...
          <ClaimWingerSkSection
            className="mb-12"
            title="Riešite meškanie alebo zrušenie letu z Krakova?"
            description="ClaimWinger vie rýchlo preveriť, či ide o silný nárok podľa EU261, alebo o citlivejší prípad, kde bude rozhodovať konečná destinácia, operujúci dopravca a dôvod narušenia na KRK."
            ctaHref="https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=embedded_cta&utm_campaign=krakow_airport_delays"
            ...
            placement="sk_blog_krakow_airport_delays_embed"
          />

          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Čo je pri KRK najdôležitejšie pochopiť
            </h2>
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  To, že problém vznikol v Krakove, ešte samo o sebe neurčuje nárok. Rozhodujúca je
          ...
          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Kedy býva nárok z Krakova najsilnejší
            </h2>
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri Krakove bývajú veľmi časté priame európske trasy. Ak je let v rozsahu EU261 a
                  do cieľa prídete výrazne neskôr, nárok môže byť silný aj bez komplikovaného itinerára.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak Krakov bol len prvým úsekom jednej cesty, rozhodovať môže až konečná destinácia
                  celej rezervácie, nie len prvé meškanie na KRK.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
          ...
          <section className="mb-12">
            <Card className="border-rose-200 bg-rose-50 p-8 dark:border-rose-800 dark:bg-rose-950/20">
              ...
              <p className="mb-6 text-base leading-7 text-slate-700 dark:text-slate-300">
                Pri letisku Krakov má veľký zmysel rýchlo oddeliť silný prípad od citlivejšej situácie
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild size="lg" className="bg-rose-600 hover:bg-rose-700">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_krakow_airport_delays_final_cta_delay",
                        delayedFlightHref
                      )
                    }
                  >
                ...
                <Button asChild size="lg" variant="outline">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_krakow_airport_delays_final_cta_cancelled",
                        cancelledFlightHref
                      )
                    }
                  >
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <a
                  ...
                  onClick={() =>
                    trackClaimClick(
                      "sk_krakow_airport_delays_related_home",
                      claimWingerHomeHref
                    )
                  }
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak Krakov bol len prvou časťou jednej cesty a problém sa prejavil ďalej.
                </p>
                <Link
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-3 text-lg font-semibold text-slate-900 dark:text-white">
                  Letisko Budapešť (BUD)
                </h3>
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak porovnávate podobný airport intent v regióne strednej Európy.
                </p>
                <Link
                  href="/sk/blog/letisko-budapest-bud-meskania"
                  className="font-semibold text-blue-600 underline underline-offset-4"
                >
                  Prejsť na BUD článok
                </Link>
              </Card>
            </div>
          </section>
