...
const articleUrl =
  "https://problemlot.com/sk/blog/letisko-amsterdam-ams-meskania";
const delayedFlightHref =
  "https://claimwinger.com/sk/meskajuci-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=amsterdam_ams_airport_delays";
const cancelledFlightHref =
  "https://claimwinger.com/sk/zruseny-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=amsterdam_ams_airport_delays";
const claimWingerHomeHref =
  "https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=amsterdam_ams_airport_delays";
...
const faqItems = [
  ...
  {
    question: "Počíta sa pri AMS prvý segment alebo celý itinerár?",
    answer:
      "Ak bola cesta na jednej rezervácii, pri posudzovaní nároku býva kľúčový celý itinerár a konečná destinácia, nie len prvý úsek do alebo z AMS.",
  },
  {
    question: "Je pri AMS dôležité, kto bol skutočne operujúci dopravca?",
    answer:
      "Áno. Pri veľkých huboch ako AMS sa často miešajú marketingové kódy, partneri a codeshare. Rozhodujúce je, kto let reálne operoval a ako bola rezervácia postavená.",
  },
];
...
export default function LetiskoAmsterdamAmsMeskaniaPage() {
  return (
    <LayoutSk>
      <SEO
        title="Letisko Amsterdam (AMS) meškania: práva pasažiera, odškodnenie a čo rozhoduje"
        description="Meškal vám, zrušili alebo výrazne presunuli let z alebo do letiska Amsterdam Schiphol (AMS)? Zistite, kedy vzniká nárok, prečo je pri AMS kľúčová konečná destinácia a ako fungujú prestupy na veľkom hube."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline:
              "Letisko Amsterdam (AMS) meškania: práva pasažiera, odškodnenie a čo rozhoduje",
            description:
              "Praktický sprievodca pre cestujúcich pri meškaní alebo zrušení letu na letisku Amsterdam Schiphol vrátane úlohy konečnej destinácie, jednej rezervácie a operujúceho dopravcu.",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Letisko Amsterdam (AMS) meškania",
                item: articleUrl,
              },
            ],
          }),
      ...
      <article className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50 dark:from-gray-950 dark:via-gray-900 dark:to-slate-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span>/</span>
            <span>Letisko Amsterdam (AMS) meškania</span>
          </div>
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-orange-100 px-4 py-2 text-sm font-medium text-orange-700 dark:bg-orange-900/30 dark:text-orange-300">
              Airport content pre Amsterdam Schiphol (AMS)
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Letisko Amsterdam (AMS): čo robiť pri meškaní alebo zrušení letu?
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Ak riešite problém na <strong>letisku Amsterdam Schiphol (AMS)</strong>, nestačí
              pozerať len na samotné letisko. Pri nároku býva kľúčové, či bol <strong>AMS</strong>
          ...
          <section className="mb-10">
            <Card className="border-orange-200 bg-gradient-to-br from-orange-600 to-amber-700 p-8 text-white shadow-xl dark:border-orange-800">
              ...
              <div className="space-y-3 text-base leading-7 text-orange-50">
                <p>
                  <strong>Áno, často áno.</strong> Ak váš let z AMS meškal alebo bol zrušený, nárok
                ...
                <p>
                  Pri AMS je obzvlášť dôležité odlíšiť jednoduchý priamy let od cesty cez veľký
          ...
          <ClaimWingerSkSection
            className="mb-12"
            title="Riešite meškanie alebo zrušenie letu z Amsterdamu AMS?"
            ...
            ctaHref="https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=embedded_cta&utm_campaign=amsterdam_ams_airport_delays"
            ...
            placement="sk_blog_amsterdam_ams_airport_delays_embed"
          />

          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Čo je pri AMS najdôležitejšie pochopiť
            </h2>
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <Plane className="mb-3 h-6 w-6 text-orange-600" />
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
                  AMS je veľký hub
                </h3>
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri Amsterdame Schiphol veľmi často nejde len o jeden bod cesty. Mnohé prípady sa
                  týkajú prestupu a celej nadväznej trasy.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <Clock className="mb-3 h-6 w-6 text-orange-600" />
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
                  Počíta sa konečný cieľ
                </h3>
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri kompenzácii je často kľúčové, aký bol výsledok celej cesty v konečnej destinácii,
                  nie len problém na jednom segmente do alebo z AMS.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <AlertCircle className="mb-3 h-6 w-6 text-orange-600" />
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
          ...
          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Kedy býva nárok z AMS najsilnejší
            </h2>
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Aj z AMS sa riešia bežné priame lety po Európe. Ak sa na let uplatní EU261 a do
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri AMS býva časté, že Amsterdam nie je cieľ, ale len prestupný bod. Vtedy často
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri AMS má veľký význam správne určiť, či let skutočne operovala KLM alebo partner,
                  a ako bola postavená rezervácia v rámci celej siete.
                </p>
              </Card>
            </div>
          </section>
          ...
          <section className="mb-12">
            <Card className="border-orange-200 bg-orange-50 p-8 dark:border-orange-800 dark:bg-orange-950/20">
              ...
              <p className="mb-6 text-base leading-7 text-slate-700 dark:text-slate-300">
                Pri AMS má veľký zmysel rýchlo oddeliť jednoduchý silný prípad od citlivejšej hubovej
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild size="lg" className="bg-orange-600 hover:bg-orange-700">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_amsterdam_ams_airport_delays_final_cta_delay",
                        delayedFlightHref
                      )
                    }
                  >
                ...
                <Button asChild size="lg" variant="outline">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_amsterdam_ams_airport_delays_final_cta_cancelled",
                        cancelledFlightHref
                      )
                    }
                  >
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <a
                  ...
                  onClick={() =>
                    trackClaimClick(
                      "sk_amsterdam_ams_airport_delays_related_home",
                      claimWingerHomeHref
                    )
                  }
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Užitočné, ak problém na AMS súvisí priamo s KLM ako operujúcim dopravcom.
                </p>
                <Link
                  href="/sk/blog/klm-odskodnenie"
                  className="font-semibold text-blue-600 underline underline-offset-4"
                >
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Kľúčové, ak bol Amsterdam len prestupným bodom a skutočný problém sa prejavil až ďalej.
                </p>
                <Link
