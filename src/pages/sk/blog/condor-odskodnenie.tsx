...
const articleUrl = "https://problemlot.com/sk/blog/condor-odskodnenie";
const delayedFlightHref =
  "https://claimwinger.com/sk/meskajuci-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=condor_compensation";
const cancelledFlightHref =
  "https://claimwinger.com/sk/zruseny-let?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=condor_compensation";
const claimWingerHomeHref =
  "https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=article_link&utm_campaign=condor_compensation";
...
const faqItems = [
  ...
  {
    question: "Koľko môžem dostať od Condoru?",
    answer:
...
export default function CondorOdskodneniePage() {
  return (
    <LayoutSk>
      <SEO
        title="Condor odškodnenie: kedy vzniká nárok a koľko môžete dostať"
        description="Meškal vám, zrušili alebo výrazne presunuli let Condor? Zistite, kedy vzniká nárok na odškodnenie, kedy ide o 250 €, 400 € alebo 600 € a čo pri EU261 rozhoduje."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Condor odškodnenie: kedy vzniká nárok a koľko môžete dostať",
            description:
              "Praktický sprievodca pre cestujúcich pri problémoch s letom Condor vrátane výšky nároku, pravidiel EU261 a významu európskeho dopravcu pri dovolenkových a dlhých trasách.",
        ...
        <div className="mx-auto max-w-4xl px-4 py-12">
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-amber-100 px-4 py-2 text-sm font-medium text-amber-700 dark:bg-amber-900/30 dark:text-amber-300">
              Airline content pre Condor
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Condor odškodnenie: kedy vzniká nárok?
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Ak ste leteli s <strong>Condor</strong> a nastal problém, odpoveď býva často priaznivá.
          ...
          <section className="mb-10">
            <Card className="border-amber-200 bg-gradient-to-br from-amber-600 to-orange-700 p-8 text-white shadow-xl dark:border-amber-800">
              ...
              <div className="space-y-3 text-base leading-7 text-amber-50">
                <p>
                  <strong>Áno, často áno.</strong> Condor je európska aerolinka, takže pri mnohých
                ...
                <p>
                  ...
                  do konečnej destinácie a či Condor naozaj vie preukázať mimoriadne okolnosti.
                </p>
              </div>
            </Card>
          </section>
          ...
          <ClaimWingerSkSection
            className="mb-12"
            title="Riešite meškanie alebo zrušenie letu Condor?"
            ...
            ctaHref="https://claimwinger.com/sk?utm_source=problemlot-sk&utm_medium=embedded_cta&utm_campaign=condor_compensation"
            ...
            placement="sk_blog_condor_compensation_embed"
          />

          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Prečo je pri Condore dôležité, že ide o dopravcu z EÚ
            </h2>
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri letoch z tretích krajín späť do EÚ býva fakt, že Condor je dopravca z EÚ,
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {[
                ...
                "máte rezerváciu, číslo letu a komunikáciu od Condor",
          ...
          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Čo pri Condore najčastejšie komplikuje posúdenie
            </h2>
            <div className="grid gap-4">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
                  Dovolenkové a sezónne trasy
                </h3>
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Pri Condore sa často riešia dovolenkové a sezónne lety. Samotný rekreačný charakter
                  cesty nič nemení na právach pasažiera, ale v praxi býva dôležité presne čítať itinerár
                  a konečnú destináciu.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Condor lieta aj na dlhých trasách mimo Európy. Pri takých itinerároch býva dôležité
                  presne čítať operujúceho dopravcu, jednu rezerváciu a výsledok v konečnej destinácii.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg max-w-none text-slate-700 dark:prose-invert dark:text-slate-300">
              <p>
                ...
                Condore prakticky veľmi podstatné.
              </p>
              <p>
                Pri Condore je preto rozumné nehodnotiť prípad len podľa značky alebo ceny letenky.
                V praxi často rozhoduje kombinácia trasy, jednej rezervácie a konečnej destinácie.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            <Card className="border-amber-200 bg-amber-50 p-8 dark:border-amber-800 dark:bg-amber-950/20">
              ...
              <p className="mb-6 text-base leading-7 text-slate-700 dark:text-slate-300">
                Pri Condore má veľký zmysel rýchlo oddeliť silný prípad od zložitejšej situácie
                s dovolenkovou trasou, partnerom, zdieľaným kódom alebo tvrdenými mimoriadnymi okolnosťami.
              </p>
              <div className="flex flex-wrap gap-3">
                <Button asChild size="lg" className="bg-amber-600 hover:bg-amber-700">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick("sk_condor_compensation_final_cta_delay", delayedFlightHref)
                    }
                  >
                ...
                <Button asChild size="lg" variant="outline">
                  <a
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "sk_condor_compensation_final_cta_cancelled",
                        cancelledFlightHref
                      )
                    }
                  >
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() =>
                    trackClaimClick("sk_condor_compensation_related_home", claimWingerHomeHref)
                  }
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak Condor bol len časťou jednej cesty a problém sa prejavil ďalej v itinerári.
                </p>
                <Link
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Ak porovnávate podobný long-haul kontext pri inej európskej aerolinke.
                </p>
                <Link
                  href="/sk/blog/air-europa-odskodnenie"
                  className="font-semibold text-blue-600 underline underline-offset-4"
                >
                  Prejsť na článok o Air Europa
                </Link>
              </Card>
            </div>
          </section>
