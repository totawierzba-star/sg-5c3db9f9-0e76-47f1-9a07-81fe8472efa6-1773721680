  ...
  return (
    <LayoutCs>
      <SEO 
        ...
        keywords="eurowings kompenzace, eurowings reklamace, eurowings zpoždění, eurowings zrušený let, eurowings odszkodowanie"
        ogImage="https://lotproblem.pl/og-image.png"
      />
