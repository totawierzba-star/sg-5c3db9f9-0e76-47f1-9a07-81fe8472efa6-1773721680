  ...
  return (
    <LayoutIt>
      <SEO 
        ...
        canonicalUrl="https://problemlot.com/it/blog/ita-airways-risarcimento"
      />
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white p-8 rounded-xl shadow-xl mb-12">
            ...
            <div className="text-center">
              <Link
                href="https://claimwinger.com/it?utm_source=blog&utm_medium=article&utm_campaign=ita_airways"
              ...
              >
                Verifica il Tuo Risarcimento ITA Airways
