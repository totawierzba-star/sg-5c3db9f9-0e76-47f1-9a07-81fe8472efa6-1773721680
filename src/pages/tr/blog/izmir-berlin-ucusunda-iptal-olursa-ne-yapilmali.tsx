...
const SLUG = "izmir-berlin-ucusunda-iptal-olursa-ne-yapilmali";
const CLAIM_URL =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-izmir-berlin-cancelled-flight&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-izmir-berlin-cancelled-flight&utm_content=text_link";

export default function TrIzmirBerlinCancellationArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Izmir-Berlin ucusunda iptal olursa ne yapilmali?"
        description="Izmir-Berlin ucusunda iptal olursa ne yapilmali? Turk yolcular icin yeni rota, nihai varis ve tazminat mantigini anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Izmir-Berlin ucusunda iptal olursa ne yapilmali?",
            description:
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Izmir-Berlin ucusunda iptal olursa ilk neye bakilmali?",
                acceptedAnswer: {
                  "@type": "Answer",
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Izmir-Berlin iptal rehberi</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Izmir-Berlin ucusunda iptal olursa ne yapilmali?
            </h1>
            <p className="text-xl leading-8 text-slate-600 dark:text-slate-300">
              Bu rota, diaspora ve duzenli Avrupa aile seyahatleri icin en guclu niyet alanlarindan biridir.
              Kullanici genelde ayni anda iki soruyu sorar: “Simdi ne yapmaliyim?” ve
              “Bu dosya ne kadar guclu olabilir?” Dogru analiz, <strong>bildirim zamani</strong>,
              <strong> yeni rota kalitesi</strong> ve <strong>Berlin'e nihai varis sonucu</strong> birlikte
          ...
          <section className="mb-10 rounded-3xl border border-red-200 bg-red-50 p-8 dark:border-red-900 dark:bg-red-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              <strong>Izmir-Berlin hattinda iptal olursa ilk odak noktasi, yeni cozumun kalitesi olmalidir.</strong>
          ...
          <ClaimWingerTrSection
            className="mb-10"
            badge="ClaimWinger Izmir-Berlin analizi"
            title="Izmir-Berlin iptal dosyanizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            placement="tr_izmir_berlin_cancel_article_embed_high"
          />
          ...
          <section className="mb-10">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Izmir-Berlin iptal dosyalarinda kullanicinin ilk duygusu genelde hizli cozum arayisidir. Ancak claim
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_izmir_berlin_cancel_article_text_link",
          ...
          <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <h2 className="mb-5 flex items-center gap-2 text-3xl font-bold text-slate-900 dark:text-white">
              ...
              3. Duzenli Almanya rotalarinda cozum kalitesi sonucu belirler
            </h2>
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Izmir-Berlin gibi duzenli hatlarda kullanici bazen “zaten alternatif bulunur” diye dusunur. Oysa
            ...
            <div className="space-y-6">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">
                  Izmir-Berlin ucusunda iptal olursa ilk neye bakilmali?
                </h3>
