...
const SLUG = "izmir-amsterdam-ucusunda-iptal-olursa-ne-yapilmali";
const CLAIM_URL =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-izmir-amsterdam-cancelled-flight&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-izmir-amsterdam-cancelled-flight&utm_content=text_link";

export default function TrIzmirAmsterdamCancellationArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Izmir-Amsterdam ucusunda iptal olursa ne yapilmali?"
        description="Izmir-Amsterdam ucusunda iptal olursa ne yapilmali? Turk yolcular icin yeni rota, nihai varis ve tazminat mantigini anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Izmir-Amsterdam ucusunda iptal olursa ne yapilmali?",
            description:
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Izmir-Amsterdam ucusunda iptal olursa ilk neye bakilmali?",
                acceptedAnswer: {
                  "@type": "Answer",
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Izmir-Amsterdam iptal rehberi</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Izmir-Amsterdam ucusunda iptal olursa ne yapilmali?
            </h1>
            <p className="text-xl leading-8 text-slate-600 dark:text-slate-300">
              Bu rota, Hollanda tarafindaki diaspora ve aile/duzenli seyahat niyetini birlestiren cok guclu bir
              long-taildir. Kullanici genelde ayni anda iki soruyu sorar: “Simdi ne yapmaliyim?” ve
          ...
          <section className="mb-10 rounded-3xl border border-red-200 bg-red-50 p-8 dark:border-red-900 dark:bg-red-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              <strong>Izmir-Amsterdam hattinda iptal olursa ilk odak noktasi, yeni cozumun kalitesi olmalidir.</strong>
          ...
          <ClaimWingerTrSection
            className="mb-10"
            badge="ClaimWinger Izmir-Amsterdam analizi"
            title="Izmir-Amsterdam iptal dosyanizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            ctaHref={CLAIM_URL}
            ctaLabel="Izmir-Amsterdam dosyami kontrol et"
            placement="tr_izmir_amsterdam_cancel_article_embed_high"
          />
          ...
          <section className="mb-10">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Izmir-Amsterdam iptal dosyalarinda kullanicinin ilk duygusu genelde hizli cozum arayisidir. Ancak
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_izmir_amsterdam_cancel_article_text_link",
          ...
          <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <h2 className="mb-5 flex items-center gap-2 text-3xl font-bold text-slate-900 dark:text-white">
              ...
              3. Duzenli Hollanda rotalarinda cozum kalitesi sonuca agirlik verir
            </h2>
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Izmir-Amsterdam gibi duzenli hatlarda kullanici bazen “zaten alternatif bulunur” diye dusunur. Oysa
          ...
          <section className="mb-10 rounded-3xl border border-amber-200 bg-amber-50 p-8 dark:border-amber-900 dark:bg-amber-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              ...
              saklayin. Bu tip Amsterdam dosyalarinda olay akisinin kronolojik duzeni sonradan cok buyuk fark yaratir.
            </p>
          </section>
            ...
            <div className="space-y-6">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">
                  Izmir-Amsterdam ucusunda iptal olursa ilk neye bakilmali?
                </h3>
