...
const SLUG = "paris-istanbul-ucusunda-yeni-bilet-masrafi-ne-zaman-geri-istenebilir";
const CLAIM_URL =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-paris-istanbul-new-ticket-cost&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-paris-istanbul-new-ticket-cost&utm_content=text_link";

export default function TrParisIstanbulNewTicketCostArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Paris-Istanbul ucusunda yeni bilet masrafi ne zaman geri istenebilir?"
        description="Paris-Istanbul ucusunda yeni bilet masrafi ne zaman geri istenebilir? Turk yolcular icin yeni bilet alma karari, makul secim ve belge duzenini anlatan rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Paris-Istanbul ucusunda yeni bilet masrafi ne zaman geri istenebilir?",
            description:
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Paris-Istanbul yeni bilet masrafi</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Paris-Istanbul ucusunda yeni bilet masrafi ne zaman geri istenebilir?
            </h1>
          ...
          <ClaimWingerTrSection
            ...
            title="Paris-Istanbul yeni bilet masrafinizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            placement="tr_paris_istanbul_new_ticket_cost_article_embed_high"
          />
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_paris_istanbul_new_ticket_cost_article_text_link",
            ...
            <div className="space-y-4">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                ...
                <p className="text-slate-700 dark:text-slate-200">
                  Hayir. En guclu dosyalar, yeni biletin gercekten gerekli hale geldigi, havayolunun yeterli cozum
                  sunmadigi ve secimin makul kaldigi durumlardir.
                </p>
              </div>
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">
                ...
                <p className="text-slate-700 dark:text-slate-200">
                  En kritik nokta, karar aninin mantikli olmasi ve secilen yeni biletin savunulabilir bir cozum
                  sunmasidir. Cok pahali veya gereksiz aceleci secimler dosyayi zayiflatabilir.
                </p>
              </div>
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">
                ...
                <p className="text-slate-700 dark:text-slate-200">
                  ...
                  hedefe gercek varis sonucunu gosteren belgeler birlikte saklanmalidir.
                </p>
              </div>
            </div>
          </section>
