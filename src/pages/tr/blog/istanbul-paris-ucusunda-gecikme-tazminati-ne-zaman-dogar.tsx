...
const SLUG = "istanbul-paris-ucusunda-gecikme-tazminati-ne-zaman-dogar";
const CLAIM_URL =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-istanbul-paris-delay&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-istanbul-paris-delay&utm_content=text_link";

export default function TrIstanbulParisDelayArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Istanbul-Paris ucusunda gecikme tazminati ne zaman dogar?"
        description="Istanbul-Paris ucusunda gecikme tazminati ne zaman dogar? Turk yolcular icin nihai varis, rota mantigi ve claim gucunu anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Istanbul-Paris ucusunda gecikme tazminati ne zaman dogar?",
            description:
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Istanbul-Paris ucusunda gecikmede ilk neye bakilmali?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Ilk olarak yolcunun Paris'e gercekte ne zaman vardigina, hangi havayolunun ucusu islettigine ve gecikmenin tum rota uzerindeki etkisine bakilmalidir.",
                },
              },
              {
                "@type": "Question",
                name: "Istanbul-Paris rotasinda sadece dakika sayisi yeterli midir?",
                acceptedAnswer: {
                  "@type": "Answer",
              ...
              {
                "@type": "Question",
                name: "Istanbul-Paris gecikme dosyasinda hangi belgeler saklanmali?",
                acceptedAnswer: {
                  "@type": "Answer",
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Istanbul-Paris gecikme rehberi</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Istanbul-Paris ucusunda gecikme tazminati ne zaman dogar?
            </h1>
            <p className="text-xl leading-8 text-slate-600 dark:text-slate-300">
              Istanbul-Paris rotasi, diaspora, turistik ve is seyahatleri nedeniyle cok guclu bir arama niyeti tasir.
          ...
          <section className="mb-10 rounded-3xl border border-red-200 bg-red-50 p-8 dark:border-red-900 dark:bg-red-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              <strong>Istanbul-Paris hattinda gecikme dosyasinin kalbi, Paris'e gercek varis saatidir.</strong>
          ...
          <ClaimWingerTrSection
            className="mb-10"
            badge="ClaimWinger Istanbul-Paris gecikme analizi"
            title="Istanbul-Paris gecikme dosyanizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            placement="tr_istanbul_paris_delay_article_embed_high"
          />
          ...
          <section className="mb-10 grid gap-6 md:grid-cols-2">
            <div className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
              ...
              <ul className="space-y-3 text-slate-700 dark:text-slate-200">
                <li>Paris'e gercek varis saatinin net belgelenmesi.</li>
            ...
            <div className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
              ...
              <ul className="space-y-3 text-slate-700 dark:text-slate-200">
                ...
                <li>Paris final saatini kaydetmemek.</li>
          ...
          <section className="mb-10">
            <h2 className="mb-5 text-3xl font-bold text-slate-900 dark:text-white">
              1. Istanbul-Paris dosyasinda ilk soru: Paris'e ne zaman vardiniz?
            </h2>
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Kullanici cogu zaman sadece kalkis saatine odaklanir. Oysa bu rotada asıl kritik veri, yolcunun
                Paris'e gercekte ne zaman vardigidir. Cunku dosyanin agirligi, final zaman kaybi uzerinden daha net
                gorunur.
              </p>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Istanbul-Paris rotasinda yuzeysel bakis yeterli olmaz. Hangi havayolunun ucusu gercekte islettigi,
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_istanbul_paris_delay_article_text_link",
          ...
          <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Gecikme dosyalarinda kullanicilar hakli olarak saat ve dakika sorusuna odaklanir. Ancak Istanbul-Paris
          ...
          <section className="mb-10 rounded-3xl border border-amber-200 bg-amber-50 p-8 dark:border-amber-900 dark:bg-amber-900/20">
            ...
            <ul className="space-y-3 text-lg leading-8 text-slate-700 dark:text-slate-200">
              ...
              <li>Paris'e gercek varis saatinizi not edin.</li>
            ...
            <div className="space-y-6">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-semibold text-slate-900 dark:text-white">
                  Istanbul-Paris ucusunda gecikmede ilk neye bakilmali?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
                  Ilk olarak yolcunun Paris'e gercekte ne zaman vardigina, hangi havayolunun ucusu islettigine ve
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-semibold text-slate-900 dark:text-white">
                  Istanbul-Paris rotasinda sadece dakika sayisi yeterli midir?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-semibold text-slate-900 dark:text-white">
                  Istanbul-Paris gecikme dosyasinda hangi belgeler saklanmali?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
