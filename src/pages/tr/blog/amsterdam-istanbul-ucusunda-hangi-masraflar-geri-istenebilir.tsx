...
const SLUG = "amsterdam-istanbul-ucusunda-hangi-masraflar-geri-istenebilir";
const CLAIM_URL =
  "https://claimwinger.com/tr?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-amsterdam-istanbul-expenses&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-amsterdam-istanbul-expenses&utm_content=text_link";

export default function TrAmsterdamIstanbulExpensesArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Amsterdam-Istanbul ucusunda hangi masraflar geri istenebilir?"
        description="Amsterdam-Istanbul ucusunda hangi masraflar geri istenebilir? Turk yolcular icin yemek, otel, transfer ve yeni bilet masraflarini anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Amsterdam-Istanbul ucusunda hangi masraflar geri istenebilir?",
            description:
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Amsterdam-Istanbul masraf rehberi</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Amsterdam-Istanbul ucusunda hangi masraflar geri istenebilir?
            </h1>
          ...
          <ClaimWingerTrSection
            ...
            title="Amsterdam-Istanbul masraf dosyanizdaki hangi kalemlerin daha guclu oldugunu hizli kontrol edin"
            ...
            placement="tr_amsterdam_istanbul_expenses_article_embed_high"
          />
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_amsterdam_istanbul_expenses_article_text_link",
