...
const SLUG = "almanya-turkiye-ucusunda-hangi-masraflar-geri-istenebilir";
const CLAIM_URL =
  "https://claimwinger.com/tr?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-germany-turkey-expenses&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-germany-turkey-expenses&utm_content=text_link";

export default function TrGermanyTurkeyExpensesArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Almanya-Turkiye ucusunda hangi masraflar geri istenebilir?"
        description="Almanya-Turkiye ucusunda hangi masraflar geri istenebilir? Turk yolcular icin yemek, otel, transfer ve yeni bilet masraflarini anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Almanya-Turkiye ucusunda hangi masraflar geri istenebilir?",
            description:
              "Almanya-Turkiye ucusunda hangi masraflar geri istenebilir? Turk yolcular icin yemek, otel, transfer ve yeni bilet masraflarini anlatan net rehber.",
            author: {
              "@type": "Organization",
              name: "ProblemLot.com",
            },
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Geri istenebilir masraflar</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Almanya-Turkiye ucusunda hangi masraflar geri istenebilir?
            </h1>
          ...
          <ClaimWingerTrSection
            ...
            title="Masraf dosyanizdaki hangi kalemlerin daha guclu oldugunu hizli kontrol edin"
            ...
            placement="tr_germany_turkey_expenses_article_embed_high"
          />
          ...
          <section className="mb-10">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                ...
                cok unutup sonra da belgeleyemediği alanlardan biridir. Oysa en basit fis bile sonra buyuk fark
                yaratabilir.
              </p>
              <p>
                Bu nedenle havaalanindaki kucuk harcamalar bile duzenli sekilde saklanmalidir.
              </p>
            </div>
          </section>
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_germany_turkey_expenses_article_text_link",
          ...
          <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              ...
              <p>
                Hatirlamaya dayali liste yerine belgeye dayali liste her zaman daha temizdir.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10 rounded-3xl border border-amber-200 bg-amber-50 p-8 dark:border-amber-900 dark:bg-amber-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              En buyuk yanilgi, ya hic masraf talep etmemek ya da mantiksiz yuksek harcamalarin otomatik kabul
              edilecegini sanmaktir. Güç, makulluk ve belge duzeninden gelir.
            </p>
          </section>
            ...
            <div className="space-y-4">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">
                  Her harcama geri alinir mi?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
                  Hayir. En guclu masraflar, makul olan ve iyi belgelenen kalemlerdir.
                </p>
              </div>

              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">
                  En sik hangi kalemler cikiyor?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
                  Yemek, icecek, otel, transfer ve bazen yeni bilet veya ek ulasim masraflari en sik gorulen
                  kalemlerdir.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">
                  Fis ve fatura gerekli mi?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
                  Evet. Fis ve fatura yoksa masrafi sonradan savunmak daha zor hale gelir.
                </p>
              </div>
            </div>
          </section>
