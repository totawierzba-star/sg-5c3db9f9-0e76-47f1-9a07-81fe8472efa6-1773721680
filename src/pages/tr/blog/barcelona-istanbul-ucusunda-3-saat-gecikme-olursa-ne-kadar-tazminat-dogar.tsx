...
const SLUG = "barcelona-istanbul-ucusunda-3-saat-gecikme-olursa-ne-kadar-tazminat-dogar";
const CLAIM_URL =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-barcelona-istanbul-3-hour-delay&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-barcelona-istanbul-3-hour-delay&utm_content=text_link";

export default function TrBarcelonaIstanbulThreeHourDelayArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Barcelona-Istanbul ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?"
        description="Barcelona-Istanbul ucusunda 3 saat gecikmede ne kadar tazminat dogabilir? Turk yolcular icin nihai varis, rota mesafesi ve claim mantigini anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Barcelona-Istanbul ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?",
            description:
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Barcelona-Istanbul hattinda 3 saat gecikme oldugunda para otomatik midir?",
                acceptedAnswer: {
                  "@type": "Answer",
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "En kritik saat, ucagin Barcelona'dan ne zaman kalktigi degil; yolcunun Istanbul'a gercekte ne zaman vardigidir.",
                },
              },
              {
                "@type": "Question",
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Barcelona-Istanbul 3 saat gecikme</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Barcelona-Istanbul ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?
            </h1>
            <p className="text-xl leading-8 text-slate-600 dark:text-slate-300">
              Bu, Turk yolcular ve Ispanya hattini kullanan diaspora icin cok guclu bir arama niyetidir.
              Kullanici genelde sadece “3 saat olduysa kac para?” sorusuna cevap arar. Oysa gercek analiz,
              <strong> Istanbul'a nihai varis</strong>, <strong>rota mesafesi</strong> ve <strong>dosyanin hukuki
          ...
          <ClaimWingerTrSection
            ...
            title="Barcelona-Istanbul 3 saat gecikme dosyanizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            placement="tr_barcelona_istanbul_3h_article_embed_high"
          />
          ...
          <section className="mb-10">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Kullanici bazen kalkis panosundaki gecikmeyi tek veri sanir. Oysa Barcelona-Istanbul hattinda da asil
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_barcelona_istanbul_3h_article_text_link",
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">
                  Barcelona kalkisi mi, Istanbul varisi mi daha onemli?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
                  Asil kritik veri, Istanbul'a gercek varis saatidir. Kalkistaki gecikme sadece hikayenin bir
                  parcasidir.
                </p>
              </div>
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">
                  Bu hatta dosyayi ne en cok guclendirir?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
                  Nihai varis saati, iyi saklanmis mesajlar, boarding pass ve varsa yeni rota detaylari birlikte en
                  guclu catiyi kurar.
                </p>
              </div>
            </div>
