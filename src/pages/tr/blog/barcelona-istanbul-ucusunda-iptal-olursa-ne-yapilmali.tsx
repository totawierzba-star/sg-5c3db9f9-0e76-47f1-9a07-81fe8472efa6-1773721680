...
const SLUG = "barcelona-istanbul-ucusunda-iptal-olursa-ne-yapilmali";
const CLAIM_URL =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-barcelona-istanbul-cancelled-flight&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-barcelona-istanbul-cancelled-flight&utm_content=text_link";

export default function TrBarcelonaIstanbulCancellationArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Barcelona-Istanbul ucusunda iptal olursa ne yapilmali?"
        description="Barcelona-Istanbul ucusunda iptal olursa ne yapilmali? Turk yolcular icin yeni rota, nihai varis ve tazminat mantigini anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Barcelona-Istanbul ucusunda iptal olursa ne yapilmali?",
            description:
              "Barcelona-Istanbul ucusunda iptal olursa ne yapilmali? Turk yolcular icin yeni rota, nihai varis ve tazminat mantigini anlatan net rehber.",
            author: {
              "@type": "Organization",
              name: "ProblemLot.com",
            },
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Barcelona-Istanbul ucusunda iptal olursa ilk neye bakilmali?",
                acceptedAnswer: {
                  "@type": "Answer",
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Barcelona-Istanbul iptal rehberi</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Barcelona-Istanbul ucusunda iptal olursa ne yapilmali?
            </h1>
          ...
          <section className="mb-10 rounded-3xl border border-red-200 bg-red-50 p-8 dark:border-red-900 dark:bg-red-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              <strong>Barcelona-Istanbul hattinda iptal olursa ilk odak noktasi, size sunulan yeni cozumun kalitesi olmalidir.</strong>
          ...
          <ClaimWingerTrSection
            className="mb-10"
            badge="ClaimWinger Barcelona-Istanbul analizi"
            title="Barcelona-Istanbul iptal dosyanizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            placement="tr_barcelona_istanbul_cancel_article_embed_high"
          />
          ...
          <section className="mb-10">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Barcelona-Istanbul iptal dosyalarinda kullanicinin ilk duygusu genelde karmasadir. Ancak claim
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_barcelona_istanbul_cancel_article_text_link",
          ...
          <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Barcelona-Istanbul iptal dosyasinda en guclu pratik belgeler genelde cok nettir: iptal mesaji,
                e-posta, uygulama ekranlari, yeni rota bilgisi, boarding pass ve Istanbul'a gercek varis saati. Bu
            ...
            <div className="space-y-4">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">
                  Barcelona-Istanbul ucusunda iptal olursa ilk neye bakmaliyim?
                </h3>
