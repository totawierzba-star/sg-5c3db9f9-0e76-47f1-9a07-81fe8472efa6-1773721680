...
const SLUG = "viyana-istanbul-ucusunda-gecikme-tazminati-ne-zaman-dogar";
const CLAIM_URL =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-vienna-istanbul-delay&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-vienna-istanbul-delay&utm_content=text_link";

export default function TrViennaIstanbulDelayArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Viyana-Istanbul ucusunda gecikme tazminati ne zaman dogar?"
        description="Viyana-Istanbul ucusunda gecikme tazminati ne zaman dogar? Turk yolcular icin nihai varis, rota mantigi ve claim gucunu anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Viyana-Istanbul ucusunda gecikme tazminati ne zaman dogar?",
            description:
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Viyana-Istanbul ucusunda gecikmede ilk neye bakilmali?",
                acceptedAnswer: {
                  "@type": "Answer",
              ...
              {
                "@type": "Question",
                name: "Viyana-Istanbul rotasinda sadece dakika sayisi yeterli midir?",
                acceptedAnswer: {
                  "@type": "Answer",
              ...
              {
                "@type": "Question",
                name: "Viyana-Istanbul gecikme dosyasinda hangi belgeler saklanmali?",
                acceptedAnswer: {
                  "@type": "Answer",
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Viyana-Istanbul gecikme rehberi</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Viyana-Istanbul ucusunda gecikme tazminati ne zaman dogar?
            </h1>
            <p className="text-xl leading-8 text-slate-600 dark:text-slate-300">
              Viyana-Istanbul rotasi, hem is hem aile hem de aktarmali donus seyahatleri icin guclu bir arama niyeti
          ...
          <section className="mb-10 rounded-3xl border border-red-200 bg-red-50 p-8 dark:border-red-900 dark:bg-red-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              <strong>Viyana-Istanbul hattinda gecikme dosyasinin kalbi, Istanbul'a gercek varis saatidir.</strong>
          ...
          <ClaimWingerTrSection
            className="mb-10"
            badge="ClaimWinger Viyana-Istanbul gecikme analizi"
            title="Viyana-Istanbul gecikme dosyanizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            ctaHref={CLAIM_URL}
            ctaLabel="Viyana-Istanbul dosyami kontrol et"
            placement="tr_vienna_istanbul_delay_article_embed_high"
          />
          ...
          <section className="mb-10 grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
              ...
              <ul className="space-y-3 text-slate-700 dark:text-slate-200">
                <li>Sadece Viyana kalkis gecikmesine bakmak.</li>
          ...
          <section className="mb-10">
            <h2 className="mb-5 text-3xl font-bold text-slate-900 dark:text-white">
              1. Viyana-Istanbul dosyasinda ilk soru: Istanbul'a ne zaman vardiniz?
            </h2>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Viyana-Istanbul rotasinda yuzeysel bakis yeterli olmaz. Hangi havayolunun ucusu gercekte islettigi,
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_vienna_istanbul_delay_article_text_link",
          ...
          <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Gecikme dosyalarinda kullanicilar hakli olarak saat ve dakika sorusuna odaklanir. Ancak Viyana-Istanbul
            ...
            <div className="space-y-6">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-semibold text-slate-900 dark:text-white">
                  Viyana-Istanbul ucusunda gecikmede ilk neye bakilmali?
                </h3>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-semibold text-slate-900 dark:text-white">
                  Viyana-Istanbul rotasinda sadece dakika sayisi yeterli midir?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-semibold text-slate-900 dark:text-white">
                  Viyana-Istanbul gecikme dosyasinda hangi belgeler saklanmali?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
