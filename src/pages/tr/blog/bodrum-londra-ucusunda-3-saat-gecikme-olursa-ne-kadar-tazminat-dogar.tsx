...
const SLUG = "bodrum-londra-ucusunda-3-saat-gecikme-olursa-ne-kadar-tazminat-dogar";
const CLAIM_URL =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-bodrum-london-3-hour-delay&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-bodrum-london-3-hour-delay&utm_content=text_link";

export default function TrBodrumLondonThreeHourDelayArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Bodrum-Londra ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?"
        description="Bodrum-Londra ucusunda 3 saat gecikmede ne kadar tazminat dogabilir? Turk yolcular icin nihai varis, rota mesafesi ve UK/EU mantigini anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Bodrum-Londra ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?",
            description:
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Bodrum-Londra hattinda 3 saat gecikme oldugunda para otomatik midir?",
                acceptedAnswer: {
                  "@type": "Answer",
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "En kritik saat, ucagin Bodrum'dan ne zaman kalktigi degil; yolcunun Londra'ya gercekte ne zaman vardigidir.",
                },
              },
              {
                "@type": "Question",
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Bodrum-Londra 3 saat gecikme</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Bodrum-Londra ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?
            </h1>
            <p className="text-xl leading-8 text-slate-600 dark:text-slate-300">
              Bu, yaz sezonu ve diaspora aramalarinin kesistigi cok guclu bir long-tail sorudur. Kullanici genelde
              sadece “3 saat olduysa kac para?” sorusuna cevap arar. Oysa gercek analiz, <strong>Londra'ya nihai varis</strong>,
              <strong> rota mesafesi</strong> ve <strong>dosyanin UK/EU kapsam mantigi</strong> birlikte okundugunda
              ortaya cikar.
            </p>
          ...
          <ClaimWingerTrSection
            ...
            title="Bodrum-Londra 3 saat gecikme dosyanizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            placement="tr_bodrum_london_3h_article_embed_high"
          />
          ...
          <section className="mb-10">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Kullanici bazen Bodrum havalimanindaki ilk gecikmeyi tek veri sanir. Oysa bu hatta da asil soru,
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_bodrum_london_3h_article_text_link",
          ...
          <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <h2 className="mb-5 flex items-center gap-2 text-3xl font-bold text-slate-900 dark:text-white">
              ...
              3. Yaz ve tatil rotalarinda da hesap ayni temel mantikla okunur
            </h2>
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Bodrum-Londra hattinda kullanici bazen tatil rotasi oldugu icin dosyayi daha zayif zanneder ya da tam
                tersine “her yaz rotasi icin ayni tutar cikar” diye dusunur. Ikisi de fazla basittir. Asil agirlik,
                son hedefe etkide ve bu etkinin ne kadar temiz belgelendiginde ortaya cikar.
              </p>
              <p>
                Bu nedenle yaz rotasi olmasi, tek basina ne otomatik guc ne de otomatik zayiflik yaratir.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10 rounded-3xl border border-amber-200 bg-amber-50 p-8 dark:border-amber-900 dark:bg-amber-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              Londra hatlarinda kullanicilar bazen sadece kalkis gecikmesini saklayip final varis kaydini atliyor.
              Oysa bu dosyalarda en degerli sey, ucusun son etkisini gosteren duzenli timeline'dir: ilk gecikme,
              varsa yeni saat, yeni rota ve Londra'ya gercek varis.
            </p>
          </section>
            ...
            <div className="space-y-6">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">
                  Bodrum-Londra hattinda 3 saat gecikme oldugunda para otomatik midir?
                </h3>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                ...
                <p className="text-slate-700 dark:text-slate-200">
                  En kritik saat, ucagin Bodrum'dan ne zaman kalktigi degil; yolcunun Londra'ya gercekte ne zaman
                  vardigidir.
                </p>
              </div>
