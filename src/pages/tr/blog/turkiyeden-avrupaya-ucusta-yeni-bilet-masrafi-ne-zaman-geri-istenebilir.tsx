...
const SLUG = "turkiyeden-avrupaya-ucusta-yeni-bilet-masrafi-ne-zaman-geri-istenebilir";
const CLAIM_URL =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-turkey-europe-new-ticket-cost&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-turkey-europe-new-ticket-cost&utm_content=text_link";

export default function TrTurkeyEuropeNewTicketCostArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Turkiye'den Avrupa'ya ucusta yeni bilet masrafi ne zaman geri istenebilir?"
        description="Turkiye'den Avrupa'ya ucusta yeni bilet masrafi ne zaman geri istenebilir? Turk yolcular icin yeni bilet alma karari, makul secim ve belge duzenini anlatan rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Turkiye'den Avrupa'ya ucusta yeni bilet masrafi ne zaman geri istenebilir?",
            description:
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Yeni bilet masrafi</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Turkiye'den Avrupa'ya ucusta yeni bilet masrafi ne zaman geri istenebilir?
            </h1>
          ...
          <ClaimWingerTrSection
            ...
            title="Yeni bilet masrafinizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            placement="tr_turkey_europe_new_ticket_cost_article_embed_high"
          />
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_turkey_europe_new_ticket_cost_article_text_link",
          ...
          <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              ...
              <p>
                ...
                gorunur. Ozellikle Turkiye'den Avrupa'ya giden rotalarda bu zincir iyi kurulursa dosya cok daha net
                okunur.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10 rounded-3xl border border-amber-200 bg-amber-50 p-8 dark:border-amber-900 dark:bg-amber-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              En buyuk yanilgi, yeni bilet masrafinin ya her zaman geri alinacagini ya da hic savunulamayacagini
              sanmaktir. Oysa belirleyici olan, havayolu cozumunun yetersizligi, yeni secimin makullugu ve karar aninin
              ne kadar iyi belgelenmis oldugudur.
            </p>
          </section>
            ...
            <div className="space-y-4">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                ...
                <p className="text-slate-700 dark:text-slate-200">
                  ...
                  sunmadigi durumlardir.
                </p>
              </div>

              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">
                  Yeni bilet alirken en kritik nokta ne?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
                  En kritik nokta, secimin makul ve savunulabilir olmasidir. Cok pahali veya gereksiz aceleci secimler
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                ...
                <p className="text-slate-700 dark:text-slate-200">
                  Yeni bilet faturasi, rezervasyon onayi, ilk ucusun degisiklik kayitlari, havayolu mesajlari ve son
                  hedef sonucu gosteren belgeler birlikte saklanmalidir.
                </p>
              </div>
            </div>
          </section>
