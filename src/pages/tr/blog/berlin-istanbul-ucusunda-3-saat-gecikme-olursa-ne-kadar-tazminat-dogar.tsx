...
const SLUG = "berlin-istanbul-ucusunda-3-saat-gecikme-olursa-ne-kadar-tazminat-dogar";
const CLAIM_URL =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-berlin-istanbul-3-hour-delay&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-berlin-istanbul-3-hour-delay&utm_content=text_link";

export default function TrBerlinIstanbulThreeHourDelayArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Berlin-Istanbul ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?"
        description="Berlin-Istanbul ucusunda 3 saat gecikmede ne kadar tazminat dogabilir? Turk yolcular icin nihai varis, rota mesafesi ve claim mantigini anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Berlin-Istanbul ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?",
            description:
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Berlin-Istanbul hattinda 3 saat gecikme oldugunda para otomatik midir?",
                acceptedAnswer: {
                  "@type": "Answer",
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "En kritik saat, ucagin Berlin'den ne zaman kalktigi degil; yolcunun Istanbul'a gercekte ne zaman vardigidir.",
                },
              },
              {
                "@type": "Question",
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Berlin-Istanbul 3 saat gecikme</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Berlin-Istanbul ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?
            </h1>
            <p className="text-xl leading-8 text-slate-600 dark:text-slate-300">
              Bu, Turk yolcular ve Almanya hattini sik kullanan diaspora icin en guclu arama niyetlerinden biridir.
          ...
          <ClaimWingerTrSection
            ...
            title="Berlin-Istanbul 3 saat gecikme dosyanizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            placement="tr_berlin_istanbul_3h_article_embed_high"
          />
          ...
          <section className="mb-10">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Kullanici bazen kalkis panosundaki gecikmeyi tek veri sanir. Oysa Berlin-Istanbul hattinda da asil
                soru, yolcunun Istanbul'a ne kadar gec vardigidir. Ilk gecikme kucuk gorunebilir ama final variste daha
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_berlin_istanbul_3h_article_text_link",
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                ...
                <p className="text-slate-700 dark:text-slate-200">
                  En kritik saat, ucagin Berlin'den ne zaman kalktigi degil; yolcunun Istanbul'a gercekte ne zaman
                  vardigidir.
                </p>
              </div>
