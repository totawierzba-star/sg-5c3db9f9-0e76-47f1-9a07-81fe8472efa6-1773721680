...
const SLUG = "londra-antalya-ucusunda-iptal-olursa-ne-yapilmali";
const CLAIM_URL =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-london-antalya-cancelled-flight&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-london-antalya-cancelled-flight&utm_content=text_link";

export default function TrLondonAntalyaCancellationArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Londra-Antalya ucusunda iptal olursa ne yapilmali?"
        description="Londra-Antalya ucusunda iptal olursa ne yapilmali? Turk yolcular icin yeni rota, nihai varis ve tazminat mantigini anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Londra-Antalya ucusunda iptal olursa ne yapilmali?",
            description:
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Londra-Antalya ucusunda iptal olursa ilk neye bakilmali?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Ilk olarak havayolunun ne zaman bildirim yaptigina, hangi yeni rotayi sunduguna ve yolcunun Antalya'ya gercekte ne zaman ulasacagina bakilmalidir.",
                },
              },
              {
                "@type": "Question",
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Iptal mesaji, e-posta, uygulama ekranlari, yeni rota bilgisi, boarding pass ve Antalya'ya gercek varis saatini gosteren kayitlar saklanmalidir.",
                },
              },
            ],
          }),
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Londra-Antalya iptal rehberi</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Londra-Antalya ucusunda iptal olursa ne yapilmali?
            </h1>
            <p className="text-xl leading-8 text-slate-600 dark:text-slate-300">
              Bu rota, Birlesik Krallik&apos;tan Akdeniz tarafina giden yolcular icin hem tatil hem aile tarafinda cok
              ...
              <strong> yeni rota kalitesi</strong> ve <strong>Antalya&apos;ya nihai varis sonucu</strong> birlikte
          ...
          <section className="mb-10 rounded-3xl border border-red-200 bg-red-50 p-8 dark:border-red-900 dark:bg-red-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              <strong>Londra-Antalya hattinda iptal olursa ilk odak noktasi, size sunulan yeni cozumun kalitesi olmalidir.</strong>
              Sadece “ucus iptal edildi” bilgisi yetmez; asil tablo, ne zaman haber verildigi ve Antalya&apos;ya gercekte
              ne zaman varildigi ile kurulur.
            </p>
          </section>

          <ClaimWingerTrSection
            className="mb-10"
            badge="ClaimWinger Londra-Antalya analizi"
            title="Londra-Antalya iptal dosyanizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            ctaHref={CLAIM_URL}
            ctaLabel="Londra-Antalya dosyami kontrol et"
            placement="tr_london_antalya_cancel_article_embed_high"
          />
          ...
          <section className="mb-10 grid gap-6 md:grid-cols-2">
            <div className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
              ...
              <ul className="space-y-3 text-slate-700 dark:text-slate-200">
                ...
                <li>Antalya'ya nihai varisin net belgelenmesi.</li>
            ...
            <div className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
              ...
              <ul className="space-y-3 text-slate-700 dark:text-slate-200">
                ...
                <li>Antalya'ya gercek varis zamanini kaydetmemek.</li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Londra-Antalya iptal dosyalarinda kullanicinin ilk duygusu genelde karmasadir. Ancak claim acisindan
          ...
          <section className="mb-10">
            <h2 className="mb-5 text-3xl font-bold text-slate-900 dark:text-white">
              2. Antalya'ya nihai varis, dosyanin gercek sonucunu belirler
            </h2>
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Bu hatta da en kritik saat, kalkis panosundaki yeni zaman degil, yolcunun Antalya&apos;ya gercekte ne
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_london_antalya_cancel_article_text_link",
          ...
          <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Londra-Antalya iptal dosyasinda en guclu pratik belgeler genelde cok nettir: iptal mesaji, e-posta,
                uygulama ekranlari, yeni rota bilgisi, boarding pass ve Antalya&apos;ya gercek varis saati. Bu zincir ne
          ...
          <section className="mb-10 rounded-3xl border border-amber-200 bg-amber-50 p-8 dark:border-amber-900 dark:bg-amber-900/20">
            ...
            <ul className="space-y-3 text-lg leading-8 text-slate-700 dark:text-slate-200">
              ...
              <li>Antalya'ya gercek varis zamanini kaydedin.</li>
            ...
            <div className="space-y-4">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">
                  Londra-Antalya ucusunda iptal olursa ilk neye bakilmali?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
                  Ilk olarak havayolunun ne zaman bildirim yaptigina, hangi yeni rotayi sunduguna ve yolcunun
                  Antalya&apos;ya gercekte ne zaman ulasacagina bakilmalidir.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                ...
                <p className="text-slate-700 dark:text-slate-200">
                  Iptal mesaji, e-posta, uygulama ekranlari, yeni rota bilgisi, boarding pass ve Antalya&apos;ya gercek
