...
const SLUG = "izmir-londra-ucusunda-3-saat-gecikme-olursa-ne-kadar-tazminat-dogar";
const CLAIM_URL =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-izmir-london-3-hour-delay&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-izmir-london-3-hour-delay&utm_content=text_link";

export default function TrIzmirLondonThreeHourDelayArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Izmir-Londra ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?"
        description="Izmir-Londra ucusunda 3 saat gecikmede ne kadar tazminat dogabilir? Turk yolcular icin nihai varis, rota mesafesi ve UK/EU mantigini anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Izmir-Londra ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?",
            description:
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Izmir-Londra hattinda 3 saat gecikme oldugunda para otomatik midir?",
                acceptedAnswer: {
                  "@type": "Answer",
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "En kritik saat, ucagin Izmir'den ne zaman kalktigi degil; yolcunun Londra'ya gercekte ne zaman vardigidir.",
                },
              },
              {
                "@type": "Question",
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Izmir-Londra 3 saat gecikme</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Izmir-Londra ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?
            </h1>
            <p className="text-xl leading-8 text-slate-600 dark:text-slate-300">
              Bu, Ege cikisli Avrupa rotalari icinde en guclu snippet ve conversion niyetlerinden biridir. Kullanici
              genelde sadece “3 saat olduysa kac para?” sorusuna cevap arar. Oysa gercek analiz, <strong>Londra'ya
              nihai varis</strong>, <strong>rota mesafesi</strong> ve <strong>dosyanin UK/EU kapsam mantigi</strong>
          ...
          <ClaimWingerTrSection
            ...
            title="Izmir-Londra 3 saat gecikme dosyanizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            placement="tr_izmir_london_3h_article_embed_high"
          />
          ...
          <section className="mb-10">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Kullanici bazen Izmir havalimanindaki ilk gecikmeyi tek veri sanir. Oysa bu hatta da asil soru,
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_izmir_london_3h_article_text_link",
          ...
          <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <h2 className="mb-5 flex items-center gap-2 text-3xl font-bold text-slate-900 dark:text-white">
              ...
              3. Ege cikisli Londra rotalarinda da hesap ayni temel mantikla okunur
            </h2>
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Izmir-Londra hattinda kullanici bazen tatil ya da diaspora rotasi oldugu icin dosyayi fazla basit
                okur. Oysa asıl agirlik, son hedefe etkide ve bu etkinin ne kadar temiz belgelendiginde ortaya cikar.
                Rota tipi, ancak bu temel resmi tamamlayan bir katmandir.
              </p>
              <p>
                Bu nedenle rota guclu olabilir, ama karar yine nihai varis ve belge duzeniyle verilir.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10 rounded-3xl border border-amber-200 bg-amber-50 p-8 dark:border-amber-900 dark:bg-amber-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              Bu tip Londra dosyalarinda sadece ilk ekrani degil, sonradan gelen saat degisikliklerini ve varsa yeni
              kapı ya da rota bilgisini de saklayin. Cogu zaman dosyanin gucu, bu kronolojik zincirde netlesir.
            </p>
          </section>
            ...
            <div className="space-y-6">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">
                  Izmir-Londra hattinda 3 saat gecikme oldugunda para otomatik midir?
                </h3>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                ...
                <p className="text-slate-700 dark:text-slate-200">
                  En kritik saat, ucagin Izmir'den ne zaman kalktigi degil; yolcunun Londra'ya gercekte ne zaman
                  vardigidir.
                </p>
              </div>
