...
const SLUG = "londra-istanbul-ucusunda-yeni-bilet-masrafi-ne-zaman-geri-istenebilir";
const CLAIM_URL =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-london-istanbul-new-ticket-cost&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-london-istanbul-new-ticket-cost&utm_content=text_link";

export default function TrLondonIstanbulNewTicketCostArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Londra-Istanbul ucusunda yeni bilet masrafi ne zaman geri istenebilir?"
        description="Londra-Istanbul ucusunda yeni bilet masrafi ne zaman geri istenebilir? Turk yolcular icin yeni bilet alma karari, makul secim ve belge duzenini anlatan rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Londra-Istanbul ucusunda yeni bilet masrafi ne zaman geri istenebilir?",
            description:
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Londra-Istanbul yeni bilet masrafi</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Londra-Istanbul ucusunda yeni bilet masrafi ne zaman geri istenebilir?
            </h1>
          ...
          <ClaimWingerTrSection
            ...
            title="Londra-Istanbul yeni bilet masrafinizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            placement="tr_london_istanbul_new_ticket_cost_article_embed_high"
          />
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_london_istanbul_new_ticket_cost_article_text_link",
