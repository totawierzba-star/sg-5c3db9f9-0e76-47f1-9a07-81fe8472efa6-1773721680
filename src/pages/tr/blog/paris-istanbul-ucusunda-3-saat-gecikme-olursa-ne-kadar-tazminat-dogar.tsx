...
const SLUG = "paris-istanbul-ucusunda-3-saat-gecikme-olursa-ne-kadar-tazminat-dogar";
const CLAIM_URL =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-paris-istanbul-3-hour-delay-amount&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-paris-istanbul-3-hour-delay-amount&utm_content=text_link";

export default function TrParisIstanbulThreeHourDelayAmountArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Paris-Istanbul ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?"
        description="Paris-Istanbul ucusunda 3 saat gecikmede ne kadar tazminat dogabilir? Turk yolcular icin nihai varis, rota mesafesi ve claim mantigini anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Paris-Istanbul ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?",
            description:
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Paris-Istanbul hattinda 3 saat gecikme oldugunda para otomatik midir?",
                acceptedAnswer: {
                  "@type": "Answer",
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "En kritik saat, ucagin Paris'ten ne zaman kalktigi degil; yolcunun Istanbul'a gercekte ne zaman vardigidir.",
                },
              },
              {
                "@type": "Question",
        ...
        <div className="mx-auto max-w-4xl px-4 py-12">
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Paris-Istanbul ucusunda 3 saat gecikme olursa ne kadar tazminat dogar?
            </h1>
            <p className="text-xl leading-8 text-slate-600 dark:text-slate-300">
              Bu, Turk yolcular ve Fransa hattini sik kullanan diaspora icin en guclu arama niyetlerinden biridir.
          ...
          <ClaimWingerTrSection
            ...
            placement="tr_paris_istanbul_3h_amount_article_embed_high"
          />
          ...
          <section className="mb-10">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Kullanici bazen kalkis panosundaki gecikmeyi tek veri sanir. Oysa Paris-Istanbul hattinda da asil
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_paris_istanbul_3h_amount_article_text_link",
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                ...
                <p className="text-slate-700 dark:text-slate-200">
                  En kritik saat, ucagin Paris'ten ne zaman kalktigi degil; yolcunun Istanbul'a gercekte ne zaman
                  vardigidir.
                </p>
              </div>
