...
const SLUG = "paris-istanbul-ucusunda-taksi-ve-transfer-masrafi-ne-zaman-geri-istenebilir";
const CLAIM_URL =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-paris-istanbul-transfer-cost&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/gecikmis-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-paris-istanbul-transfer-cost&utm_content=text_link";

export default function TrParisIstanbulTransferCostArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Paris-Istanbul ucusunda taksi ve transfer masrafi ne zaman geri istenebilir?"
        description="Paris-Istanbul ucusunda taksi ve transfer masrafi ne zaman geri istenebilir? Turk yolcular icin makul ulasim, geceleme sonrasi transfer ve belge duzenini anlatan rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Paris-Istanbul ucusunda taksi ve transfer masrafi ne zaman geri istenebilir?",
            description:
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Paris-Istanbul transfer masrafi</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Paris-Istanbul ucusunda taksi ve transfer masrafi ne zaman geri istenebilir?
            </h1>
          ...
          <ClaimWingerTrSection
            ...
            title="Paris-Istanbul transfer masrafinizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            placement="tr_paris_istanbul_transfer_cost_article_embed_high"
          />
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_paris_istanbul_transfer_cost_article_text_link",
          ...
          <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              ...
              <p>
                Paris-Istanbul gibi hatta havalimanina donus, gece varisi veya erken sabah yeni kalkis gibi durumlar
                bu masraflari daha somut hale getirebilir. Bu da belge duzenini daha da degerli yapar.
              </p>
            </div>
          </section>
            ...
            <div className="space-y-4">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                ...
                <p className="text-slate-700 dark:text-slate-200">
                  Hayir. En guclu transfer masraflari, aksakligin dogrudan sonucu olan, makul kalan ve belgelenebilen
                  ulasim giderleridir.
                </p>
              </div>
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">
                  Transfer masrafinda en kritik nokta nedir?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
                  En kritik nokta masrafin neden gerekli oldugunu gosterebilmektir. Havalimani-otel, otel-havalimani
                  veya zorunlu yeniden yonlendirme baglantisi net olmaliyla dosya daha guclu olur.
                </p>
              </div>
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">
                ...
                <p className="text-slate-700 dark:text-slate-200">
                  Taksi fisleri, transfer faturasi, otel kaydi, yeni ucus saati ve havayolu mesajlari birlikte
                  saklanmalidir.
                </p>
              </div>
            </div>
