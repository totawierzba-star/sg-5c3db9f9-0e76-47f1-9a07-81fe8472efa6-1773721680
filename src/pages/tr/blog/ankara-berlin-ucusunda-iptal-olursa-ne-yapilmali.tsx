...
const SLUG = "ankara-berlin-ucusunda-iptal-olursa-ne-yapilmali";
const CLAIM_URL =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-ankara-berlin-cancelled-flight&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-ankara-berlin-cancelled-flight&utm_content=text_link";

export default function TrAnkaraBerlinCancellationArticle() {
  return (
    <LayoutTr>
      <SEO
        title="Ankara-Berlin ucusunda iptal olursa ne yapilmali?"
        description="Ankara-Berlin ucusunda iptal olursa ne yapilmali? Turk yolcular icin yeni rota, nihai varis ve tazminat mantigini anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Ankara-Berlin ucusunda iptal olursa ne yapilmali?",
            description:
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Ankara-Berlin ucusunda iptal olursa ilk neye bakilmali?",
                acceptedAnswer: {
                  "@type": "Answer",
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Ankara-Berlin iptal rehberi</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Ankara-Berlin ucusunda iptal olursa ne yapilmali?
            </h1>
            <p className="text-xl leading-8 text-slate-600 dark:text-slate-300">
              Bu rota, diaspora ve duzenli Avrupa seyahatleri icin en guclu niyet alanlarindan biridir. Kullanici
              genelde ayni anda iki soruyu sorar: “Simdi ne yapmaliyim?” ve “Bu dosya ne kadar guclu olabilir?”
              Dogru analiz, <strong>bildirim zamani</strong>, <strong>yeni rota kalitesi</strong> ve
          ...
          <section className="mb-10 rounded-3xl border border-red-200 bg-red-50 p-8 dark:border-red-900 dark:bg-red-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              <strong>Ankara-Berlin hattinda iptal olursa ilk odak noktasi, yeni cozumun kalitesi olmalidir.</strong>
          ...
          <ClaimWingerTrSection
            className="mb-10"
            badge="ClaimWinger Ankara-Berlin analizi"
            title="Ankara-Berlin iptal dosyanizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            ctaHref={CLAIM_URL}
            ctaLabel="Ankara-Berlin dosyami kontrol et"
            placement="tr_ankara_berlin_cancel_article_embed_high"
          />
          ...
          <section className="mb-10">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Ankara-Berlin iptal dosyalarinda kullanicinin ilk duygusu genelde acil cozum arayisidir. Ancak claim
                acisindan ilk soru panik degil, havayolunun size ne sundugudur. Yeni ucus ayni gun mu, ertesi gun mu,
                ciddi bekleme mi var, baglanti mi bozuldu? Butun agirlik burada belirginlesir.
              </p>
              <p>
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_ankara_berlin_cancel_article_text_link",
          ...
          <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <h2 className="mb-5 flex items-center gap-2 text-3xl font-bold text-slate-900 dark:text-white">
              ...
              3. Duzenli rotalarda yeni cozumun pratik kalitesi cok onemlidir
            </h2>
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Ankara-Berlin gibi duzenli hatlarda kullanici bazen “zaten alternatif bulunur” diye dusunur. Oysa
                alternatif bulunmasi ile iyi bir cozum verilmesi ayni sey degildir. Gercek fark, yeni ucusun toplam
                kaybi ne kadar buyuttugunde ortaya cikar.
              </p>
              <p>
                Bu nedenle dosyanin agirligi, sadece alternatifin varliginda degil, kalitesinde okunmalidir.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10 rounded-3xl border border-amber-200 bg-amber-50 p-8 dark:border-amber-900 dark:bg-amber-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              Iptal oldugunda sadece ilk e-postayi degil, sonraki saat degisikliklerini ve yeni rota ekranlarini da
              saklayin. Bu tip Berlin dosyalarinda olay akisinin kronolojik duzeni sonradan cok buyuk fark yaratir.
            </p>
          </section>
            ...
            <div className="space-y-6">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">
                  Ankara-Berlin ucusunda iptal olursa ilk neye bakilmali?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
                  Ilk olarak havayolunun ne zaman bildirim yaptigina, hangi yeni rotayi sunduguna ve yolcunun
                  Berlin'e gercekte ne zaman ulasacagina bakilmalidir.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                ...
                <p className="text-slate-700 dark:text-slate-200">
                  Iptal mesaji, e-posta, yeni rota bilgisi, boarding pass ve Berlin'e gercek varis saatini gosteren
