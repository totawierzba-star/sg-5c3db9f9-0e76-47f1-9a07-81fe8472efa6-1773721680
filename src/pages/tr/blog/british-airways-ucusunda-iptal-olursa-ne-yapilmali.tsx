...
const SLUG = "british-airways-ucusunda-iptal-olursa-ne-yapilmali";
const CLAIM_URL =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=article&utm_campaign=tr-british-airways-cancelled-flight&utm_content=cta_high";
const CLAIM_URL_TEXT =
  "https://claimwinger.com/tr/iptal-edilen-ucus?utm_source=problemlot-tr&utm_medium=context_link&utm_campaign=tr-british-airways-cancelled-flight&utm_content=text_link";

export default function TrBritishAirwaysCancellationArticle() {
  return (
    <LayoutTr>
      <SEO
        title="British Airways ucusunda iptal olursa ne yapilmali?"
        description="British Airways ucusunda iptal olursa ne yapilmali? Turk yolcular icin yeni rota, nihai varis ve claim mantigini anlatan net rehber."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "British Airways ucusunda iptal olursa ne yapilmali?",
            description:
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "British Airways ucusunda iptal olursa ilk neye bakilmali?",
                acceptedAnswer: {
                  "@type": "Answer",
              ...
              {
                "@type": "Question",
                name: "British Airways iptali otomatik olarak para dogurur mu?",
                acceptedAnswer: {
                  "@type": "Answer",
              ...
              {
                "@type": "Question",
                name: "British Airways iptal dosyasinda hangi belgeler saklanmali?",
                acceptedAnswer: {
                  "@type": "Answer",
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">British Airways iptal rehberi</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              British Airways ucusunda iptal olursa ne yapilmali?
            </h1>
            <p className="text-xl leading-8 text-slate-600 dark:text-slate-300">
              British Airways aramalarinda kullanicilar cogu zaman UK baglami ve Heathrow uzerinden ilerleyen rotalar
              nedeniyle sureci hizli okumaya calisir. Oysa dogru analiz, <strong>bildirim zamani</strong>,
          ...
          <section className="mb-10 rounded-3xl border border-red-200 bg-red-50 p-8 dark:border-red-900 dark:bg-red-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              <strong>British Airways ucusunda iptal varsa ilk odak noktasi, yerine ne sunuldugudur.</strong> Sadece
          ...
          <ClaimWingerTrSection
            className="mb-10"
            badge="ClaimWinger British Airways iptal analizi"
            title="British Airways iptal dosyanizin ne kadar guclu oldugunu hizli kontrol edin"
            ...
            ctaHref={CLAIM_URL}
            ctaLabel="British Airways iptal dosyami kontrol et"
            placement="tr_british_airways_cancel_article_embed_high"
          />
          ...
          <section className="mb-10">
            <h2 className="mb-5 text-3xl font-bold text-slate-900 dark:text-white">
              1. British Airways iptal dosyalarinda ilk soru: size ne teklif edildi?
            </h2>
          ...
          <section className="mb-10">
            <h2 className="mb-5 text-3xl font-bold text-slate-900 dark:text-white">
              2. British Airways dosyalarinda nihai varis, sonucun en kritik testidir
            </h2>
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                ...
                <a
                  ...
                  onClick={() =>
                    pushClaimWingerEvent("claimwinger_cta_click", {
                      locale: "tr",
                      placement: "tr_british_airways_cancel_article_text_link",
          ...
          <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                British Airways dosyalarinda en yaygin hata, markaya bakip sureci fazla basit okumaktir. Oysa gercek
                fark, yeni ucusun toplam kaybi ne kadar buyuttugunde ve dosyanin nasil belgelendiginde ortaya cikar.
              </p>
            ...
            <div className="space-y-6">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-semibold text-slate-900 dark:text-white">
                  British Airways ucusunda iptal olursa ilk neye bakilmali?
                </h3>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-semibold text-slate-900 dark:text-white">
                  British Airways iptali otomatik olarak para dogurur mu?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-2 text-xl font-semibold text-slate-900 dark:text-white">
                  British Airways iptal dosyasinda hangi belgeler saklanmali?
                </h3>
                <p className="text-slate-700 dark:text-slate-200">
