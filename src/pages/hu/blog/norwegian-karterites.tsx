...
export default function NorwegianKarterites() {
  return (
    <LayoutHu>
      <SEO
        title="Norwegian kártérítés – késés, törlés, EU261 útmutató [2026]"
        description="Magyar útmutató Norwegian járatokhoz: mikor járhat kártérítés késés vagy törlés esetén, hogyan működik az EU261, és mire figyelj claimnél."
        url="https://problemlot.com/hu/blog/norwegian-karterites"
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Norwegian kártérítés – késés, törlés, EU261 útmutató [2026]",
            description:
              "Magyar nyelvű útmutató Norwegian járatokhoz: mikor jöhet szóba kártérítés, hogyan kell értelmezni az EU261 szabályait, és mikor erős vagy gyenge a claim.",
            author: {
              "@type": "Organization",
              name: "ProblemLot.com",
            },
            ...
            mainEntityOfPage: {
              "@type": "WebPage",
              "@id": "https://problemlot.com/hu/blog/norwegian-karterites",
            },
          }),
        }}
      />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Norwegian járatnál is járhat kártérítés?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Igen. A Norwegian járatainál is felmerülhet kártérítés, ha a járat az EU261 hatálya alá tartozik, és a késés vagy törlés megfelel a szabályoknak.",
                },
              },
              {
                "@type": "Question",
                name: "A Norwegian low-cost modellje csökkenti a jogokat?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Nem. A low-cost működés önmagában nem csökkenti az EU261 szerinti jogosultságot. A döntő mindig az útvonal, a késés vagy törlés és a bizonyítékok.",
                },
              },
              {
                "@type": "Question",
                name: "Mit tegyek, ha a Norwegian nem válaszol vagy elutasítja a claimet?",
                acceptedAnswer: {
                  "@type": "Answer",
      ...
      <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <nav className="mb-8 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 dark:text-white">Norwegian</span>
          </nav>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight text-slate-900 dark:text-white md:text-5xl">
              Norwegian kártérítés
            </h1>
            <p className="text-xl leading-8 text-slate-600 dark:text-slate-300">
              A Norwegian sok magyar utasnál jelenik meg északi, európai és időnként hosszabb útvonalaknál, ezért
          ...
          <section className="mb-10 rounded-3xl border border-blue-200 bg-blue-50 p-8 dark:border-blue-900 dark:bg-blue-900/20">
            ...
            <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              <strong>Igen, Norwegian járatnál is járhat kártérítés.</strong> A low-cost jelleg önmagában semmit nem
          ...
          <section className="mb-10 rounded-3xl bg-gradient-to-r from-blue-600 to-blue-800 p-8 text-white shadow-xl">
            <h2 className="mb-3 text-3xl font-bold">A Norwegiannél sem a márkapozíció, hanem az útvonal és a késés számít</h2>
            <p className="mb-6 text-blue-100">
              Sok utas a low-cost címke alapján próbál következtetni a jogaira, pedig a claim megítélésénél itt is az
              a fontos, hogy a járat hogyan illeszkedik az EU261 rendszerébe, és mekkora lett a végső időveszteség.
            </p>
            <a
          ...
          <section className="mb-10 grid gap-6 md:grid-cols-2">
            <div className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
              <h2 className="mb-4 flex items-center gap-2 text-2xl font-bold text-green-700 dark:text-green-400">
                ...
                Mikor lehet erős a Norwegian claim?
              </h2>
          ...
          <section className="mb-10">
            <h2 className="mb-5 text-3xl font-bold text-slate-900 dark:text-white">
              1. Norwegian és EU261: miért nem elég csak a jegy típusát nézni?
            </h2>
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                A Norwegiannél sok utas hajlamos arra gondolni, hogy a kedvezőbb ár vagy a fapados működés miatt a claim
                eleve gyengébb lesz. Az EU261 logikája azonban nem így működik.
              </p>
              <p>
                Itt is az számít, hogy a konkrét járat hogyan illeszkedik az uniós szabályrendszerbe, és mekkora lett a
                végső időveszteség.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            <h2 className="mb-5 text-3xl font-bold text-slate-900 dark:text-white">
              2. Késésnél mit kell nézni Norwegian ügyben?
            </h2>
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                A Norwegian járatoknál is gyakran a <strong>végső érkezés</strong> a döntő, nem pusztán az indulási
                csúszás. Ettől függ, hogy a tényleges időveszteség mennyire jelentős.
              </p>
              <p>
                Ez akkor is fontos, ha a járat elsőre csak kisebb késésnek tűnt, de a végén mégis komolyabb probléma
                lett belőle.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
                Norwegian törlés esetén sem elég azt megnézni, hogy kaptál-e másik járatot. A claim szempontjából a
          ...
          <section className="mb-10 grid gap-6 md:grid-cols-3">
            <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
              ...
              <p className="text-slate-700 dark:text-slate-200">
                Ez mutatja meg, mekkora lett a valódi utazási veszteség az út végén.
              </p>
            </div>
            <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
              ...
              <p className="text-slate-700 dark:text-slate-200">
                A konkrét járat EU261 szerinti helyzete mindig fontosabb, mint a márka önmagában.
              </p>
            </div>
            <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
          ...
          <section className="mb-10">
            <h2 className="mb-5 text-3xl font-bold text-slate-900 dark:text-white">
              4. Mit tegyél, ha a Norwegian nem válaszol vagy vitatja az ügyet?
            </h2>
            <div className="space-y-5 text-lg leading-8 text-slate-700 dark:text-slate-200">
              <p>
              ...
              <p>
                Sok claim nem attól gyenge, hogy a Norwegian vitatja, hanem attól, hogy az utas nem mutatja be elég
          ...
          <section className="mb-10 rounded-3xl bg-amber-50 p-8 ring-1 ring-amber-200 dark:bg-amber-900/10 dark:ring-amber-800">
            <h2 className="mb-4 text-2xl font-bold text-amber-900 dark:text-amber-300">
              Gyors ellenőrzőlista Norwegian ügyhöz
            </h2>
          ...
          <section className="mb-10 rounded-3xl bg-gradient-to-r from-slate-900 to-blue-900 p-8 text-white shadow-xl">
            <h2 className="mb-3 text-3xl font-bold">Szeretnéd gyorsan ellenőrizni a Norwegian ügyedet?</h2>
            ...
            <div className="space-y-6">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">
                  Norwegiannél is ugyanúgy működik az EU261, mint más légitársaságoknál?
                </h3>
                <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">
                  Norwegian törlésnél az új járat automatikusan lezárja a claimet?
                </h3>
                <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700">
                <h3 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">
                  Érdemes segítséget kérni Norwegian claimnél?
                </h3>
                <p className="text-lg leading-8 text-slate-700 dark:text-slate-200">
