...
const articleUrl =
  "https://problemlot.com/el/blog/akyromeni-ptisi-athina-ntoumpai-ti-dikaioumai";
const claimWingerHomeHref =
  "https://claimwinger.com/el?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_dubai_cancelled";
const delayedFlightHref =
  "https://claimwinger.com/el/kathysterimeni-ptisi?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_dubai_cancelled";
const cancelledFlightHref =
  "https://claimwinger.com/el/akyromeni-ptisi?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_dubai_cancelled";
...
const faqItems = [
  ...
  {
    question: "Γιατί εδώ μιλάμε συνήθως για 400 € και όχι για 600 €;",
    answer:
      "Γιατί η τυπική διαδρομή Αθήνα–Ντουμπάι συνδέεται συνήθως με πτήση άνω των 1.500 χλμ. αλλά κάτω από 3.500 χλμ., οπότε το πιο συνηθισμένο επίπεδο αποζημίωσης στο EU261 είναι τα 400 € και όχι τα 600 €.",
  },
];
...
export default function AthensDubaiCancelledFlightElPage() {
  return (
    <LayoutEl>
      <SEO
        title="Ακυρωμένη πτήση Αθήνα–Ντουμπάι: τι δικαιούμαι;"
        description="Ακυρώθηκε η πτήση σας από Αθήνα προς Ντουμπάι; Δείτε πότε υπάρχει επιστροφή χρημάτων, εναλλακτική μεταφορά και πιθανή αποζημίωση 400 € σύμφωνα με το EU261."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Ακυρωμένη πτήση Αθήνα–Ντουμπάι: τι δικαιούμαι;",
            description:
              "Πρακτικός οδηγός για τα δικαιώματα του επιβάτη όταν ακυρώνεται πτήση Αθήνα–Ντουμπάι, με έμφαση σε επιστροφή χρημάτων, εναλλακτική μεταφορά και αποζημίωση.",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Ακυρωμένη πτήση Αθήνα–Ντουμπάι: τι δικαιούμαι;",
                item: articleUrl,
              },
            ],
          }),
      ...
      <article className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 dark:from-gray-950 dark:via-gray-900 dark:to-slate-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span>/</span>
            <span>Ακυρωμένη πτήση Αθήνα–Ντουμπάι: τι δικαιούμαι;</span>
          </div>
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-emerald-100 px-4 py-2 text-sm font-medium text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300">
              Οδηγός διαδρομής για Αθήνα και Ντουμπάι
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Ακυρωμένη πτήση Αθήνα–Ντουμπάι: τι δικαιούμαι;
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Αν ακυρώθηκε η πτήση σας από <strong>Αθήνα προς Ντουμπάι</strong>, είναι σημαντικό
              ...
              είναι το ίδιο και, για την τυπική διαδρομή Αθήνα–Ντουμπάι, η πιο συνηθισμένη
              αναφορά για την αποζημίωση είναι τα <strong>400 €</strong>.
            </p>
          ...
          <section className="mb-10">
            <Card className="border-emerald-200 bg-gradient-to-br from-emerald-600 to-teal-700 p-8 text-white shadow-xl dark:border-emerald-800">
              ...
              <div className="space-y-3 text-base leading-7 text-emerald-50">
                ...
                <p>
                  Για τη διαδρομή Αθήνα–Ντουμπάι η πιο συνηθισμένη αναφορά για την αποζημίωση είναι
                  τα <strong>400 €</strong>, όταν η ενημέρωση για την ακύρωση έγινε αργά και δεν
          ...
          <ClaimWingerElSection
            className="mb-12"
            title="Ακυρώθηκε η πτήση σας Αθήνα–Ντουμπάι;"
            ...
            ctaHref="https://claimwinger.com/el/akyromeni-ptisi?utm_source=problemlot-el&utm_medium=embedded_cta&utm_campaign=athens_dubai_cancelled"
            ...
            placement="el_blog_athens_dubai_cancelled_embed"
          />

          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Γιατί εδώ μιλάμε συνήθως για 400 € και όχι για 600 €
            </h2>
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Η τυπική διαδρομή Αθήνα–Ντουμπάι συνδέεται συνήθως με πτήση άνω των 1.500 χλμ.
                  αλλά κάτω από 3.500 χλμ., οπότε το πιο συνηθισμένο επίπεδο αποζημίωσης είναι
                  400 €.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
          ...
          <section className="mb-12">
            <Card className="border-sky-200 bg-sky-50 p-6 dark:border-sky-900/50 dark:bg-sky-950/20">
              ...
              <div className="space-y-3 text-base leading-7 text-slate-700 dark:text-slate-300">
                <p>
                  Στη διαδρομή Αθήνα–Ντουμπάι ο βασικός νομικός κορμός είναι σχετικά καθαρός, αλλά
                ...
                <p>
                  ...
                  μιλάμε για καθαρή υπόθεση με 400 € ή για σενάριο όπου η αεροπορική επιχειρεί να
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Button asChild className="bg-sky-600 hover:bg-sky-700">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_dubai_cancelled_inline",
                        claimWingerHomeHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_dubai_cancelled_cancelled",
                        cancelledFlightHref,
                      )
                    }
                  >
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="p-6">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Χρήσιμο αν θέλετε να συγκρίνετε άλλη μεγάλη διαδρομή από την Αθήνα, όπου το
                  συνηθισμένο επίπεδο αποζημίωσης ανεβαίνει στα 600 €.
                </p>
                <Link
                  href="/el/blog/apozimiosi-gia-kathysterisi-ptisis-athina-nea-yorki"
          ...
          <section className="mb-12">
            <Card className="border-slate-200 p-8 dark:border-slate-700">
              ...
              <div className="space-y-4 text-base leading-7 text-slate-700 dark:text-slate-300">
                <p>
                  Η ακυρωμένη πτήση Αθήνα–Ντουμπάι είναι καλή περίπτωση για να φανεί ότι η
                  επιστροφή χρημάτων, η νέα πτήση και η αποζημίωση δεν είναι το ίδιο πράγμα. Για
                  την τυπική διαδρομή, η πιο συνηθισμένη αναφορά για αποζημίωση είναι τα 400 €,
                  αλλά μόνο όταν η υπόθεση πληροί πραγματικά τους όρους του EU261.
                </p>
                <p>
                  Η μεγαλύτερη προσοχή χρειάζεται στο πότε ενημερωθήκατε, στο τι εναλλακτική λύση
                  δόθηκε και στο ότι αυτή η διαδρομή, παρότι μεγάλη, συνήθως δεν μπαίνει αυτόματα
                  στην κατηγορία των 600 €.
                </p>
              </div>
            </Card>
          </section>
          ...
          <section className="mb-6">
            <Card className="border-sky-200 bg-white p-8 shadow-sm dark:border-sky-900/40 dark:bg-slate-950/60">
              <h2 className="mb-3 text-2xl font-bold text-slate-900 dark:text-white">
                Θέλετε να δείτε γρήγορα αν η ακύρωση Αθήνα–Ντουμπάι δίνει βάση για αποζημίωση;
              </h2>
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild className="bg-sky-600 hover:bg-sky-700">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_dubai_cancelled_footer_home",
                        claimWingerHomeHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_dubai_cancelled_footer_cancelled",
                        cancelledFlightHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_dubai_cancelled_footer_delayed",
                        delayedFlightHref,
                      )
                    }
                  >
