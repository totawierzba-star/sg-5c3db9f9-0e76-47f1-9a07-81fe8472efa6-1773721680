...
const articleUrl =
  "https://problemlot.com/el/blog/apozimiosi-gia-kathysterisi-ptisis-athina-thessaloniki";
const claimWingerHomeHref =
  "https://claimwinger.com/el?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_thessaloniki_delay";
const delayedFlightHref =
  "https://claimwinger.com/el/kathysterimeni-ptisi?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_thessaloniki_delay";
const cancelledFlightHref =
  "https://claimwinger.com/el/akyromeni-ptisi?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_thessaloniki_delay";
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Για μια τυπική απευθείας πτήση Αθήνα–Θεσσαλονίκη, η πιο συνηθισμένη αναφορά είναι τα 250 €, γιατί πρόκειται συνήθως για εσωτερική διαδρομή έως 1.500 χλμ.",
  },
  {
  ...
  {
    question: "Ισχύει αυτό και για εσωτερικές πτήσεις στην Ελλάδα;",
    answer:
      "Ναι. Το EU261 εφαρμόζεται και στις εσωτερικές πτήσεις εντός κράτους μέλους της ΕΕ, άρα μια πτήση Αθήνα–Θεσσαλονίκη μπορεί επίσης να εμπίπτει στο ίδιο πλαίσιο προστασίας.",
  },
];
...
export default function AthensThessalonikiDelayCompensationElPage() {
  return (
    <LayoutEl>
      <SEO
        title="Αποζημίωση για καθυστέρηση πτήσης Αθήνα–Θεσσαλονίκη"
        description="Καθυστέρησε η πτήση σας από Αθήνα προς Θεσσαλονίκη; Δείτε πότε μπορεί να υπάρχει αποζημίωση 250 €, τι μετρά πραγματικά στο EU261 και γιατί η τελική άφιξη είναι το βασικό κριτήριο."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Αποζημίωση για καθυστέρηση πτήσης Αθήνα–Θεσσαλονίκη",
            description:
              "Πρακτικός οδηγός για το πότε μια καθυστέρηση πτήσης Αθήνα–Θεσσαλονίκη μπορεί να οδηγεί σε αποζημίωση και γιατί το ποσό συνδέεται συχνά με τα 250 €.",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Αποζημίωση για καθυστέρηση πτήσης Αθήνα–Θεσσαλονίκη",
                item: articleUrl,
              },
            ],
          }),
      ...
      <article className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-sky-50 dark:from-gray-950 dark:via-gray-900 dark:to-slate-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span>/</span>
            <span>Αποζημίωση για καθυστέρηση πτήσης Αθήνα–Θεσσαλονίκη</span>
          </div>
          ...
          <header className="mb-10">
            ...
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Αποζημίωση για καθυστέρηση πτήσης Αθήνα–Θεσσαλονίκη
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Αν η πτήση σας από <strong>Αθήνα προς Θεσσαλονίκη</strong> έφτασε με καθυστέρηση
              ...
              έκτακτες περιστάσεις. Για την τυπική απευθείας διαδρομή Αθήνα–Θεσσαλονίκη, η πιο
          ...
          <section className="mb-10">
            <Card className="border-sky-200 bg-gradient-to-br from-sky-600 to-blue-700 p-8 text-white shadow-xl dark:border-sky-800">
              ...
              <div className="space-y-3 text-base leading-7 text-sky-50">
                ...
                <p>
                  Για το κλασικό σκέλος Αθήνα–Θεσσαλονίκη, η αποζημίωση συνδέεται συνήθως με τα
                  <strong> 250 €</strong>.
                </p>
                <p>
          ...
          <ClaimWingerElSection
            className="mb-12"
            title="Καθυστέρησε η πτήση σας Αθήνα–Θεσσαλονίκη;"
            ...
            ctaHref="https://claimwinger.com/el/kathysterimeni-ptisi?utm_source=problemlot-el&utm_medium=embedded_cta&utm_campaign=athens_thessaloniki_delay"
            ...
            placement="el_blog_athens_thessaloniki_delay_embed"
          />
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Για μια τυπική απευθείας πτήση Αθήνα–Θεσσαλονίκη, η διαδρομή παραμένει προφανώς
                  στο επίπεδο έως 1.500 χλμ., που είναι και ο λόγος για τον οποίο η πιο
                  συνηθισμένη αναφορά είναι τα 250 €.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
                  Εσωτερική πτήση, ίδια προστασία
                </h3>
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Το γεγονός ότι μιλάμε για εσωτερική διαδρομή στην Ελλάδα δεν μειώνει από μόνο του
                  τα δικαιώματά σας. Το EU261 εφαρμόζεται και εδώ, όπως και σε πολλές διεθνείς
                  πτήσεις εντός ΕΕ.
                </p>
              </Card>
            </div>
            ...
            <div className="grid gap-4">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  ...
                  κυρίως πόσο αργά φτάσατε τελικά στη Θεσσαλονίκη.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <div className="mb-3 flex items-center gap-2 text-slate-900 dark:text-white">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Η αεροπορική δεν αρκεί να επικαλεστεί γενικά κακό καιρό ή επιχειρησιακή πίεση.
                  Αν θέλει να αρνηθεί πληρωμή, πρέπει να δείξει ότι πράγματι υπήρχε έγκυρος λόγος
                  που δεν μπορούσε να αποφευχθεί.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <div className="mb-3 flex items-center gap-2 text-slate-900 dark:text-white">
          ...
          <section className="mb-12">
            <Card className="border-sky-200 bg-sky-50 p-6 dark:border-sky-900/50 dark:bg-sky-950/20">
              ...
              <div className="space-y-3 text-base leading-7 text-slate-700 dark:text-slate-300">
                <p>
                  Στη διαδρομή Αθήνα–Θεσσαλονίκη το βασικό πλαίσιο είναι αρκετά καθαρό, αλλά στην
                  πράξη συχνά προκύπτουν ερωτήματα για το αν η αεροπορική μιλά για απλή
                  καθυστέρηση, αλλαγή πτήσης ή πρόβλημα που επηρέασε ολόκληρη την ημέρα ταξιδιού.
                </p>
                <p>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Button asChild className="bg-sky-600 hover:bg-sky-700">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_thessaloniki_delay_inline",
                        claimWingerHomeHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_thessaloniki_delay_delayed",
                        delayedFlightHref,
                      )
                    }
                  >
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <Card className="p-6">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Χρήσιμο αν θέλετε να συγκρίνετε μια άλλη κοντινή ευρωπαϊκή διαδρομή που επίσης
                  συνδέεται συνήθως με 250 €.
                </p>
                <Link
                  href="/el/blog/apozimiosi-gia-kathysterisi-ptisis-athina-romi"
                  className="text-sm font-medium text-sky-600 hover:text-sky-700"
                >
                  Δείτε τον οδηγό
                </Link>
          ...
          <section className="mb-12">
            <Card className="border-slate-200 p-8 dark:border-slate-700">
              ...
              <div className="space-y-4 text-base leading-7 text-slate-700 dark:text-slate-300">
                <p>
                  Η διαδρομή Αθήνα–Θεσσαλονίκη είναι από τις πιο καθαρές περιπτώσεις για να
                  καταλάβει κανείς πώς λειτουργεί το EU261 και στις εσωτερικές πτήσεις. Αν η
          ...
          <section className="mb-6">
            <Card className="border-sky-200 bg-white p-8 shadow-sm dark:border-sky-900/40 dark:bg-slate-950/60">
              <h2 className="mb-3 text-2xl font-bold text-slate-900 dark:text-white">
                Θέλετε να δείτε γρήγορα αν η καθυστέρηση Αθήνα–Θεσσαλονίκη έχει βάση για
                αποζημίωση;
              </h2>
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild className="bg-sky-600 hover:bg-sky-700">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_thessaloniki_delay_footer_home",
                        claimWingerHomeHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_thessaloniki_delay_footer_delayed",
                        delayedFlightHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_thessaloniki_delay_footer_cancelled",
                        cancelledFlightHref,
                      )
                    }
                  >
