...
const articleUrl =
  "https://problemlot.com/el/blog/akyromeni-ptisi-athina-amsterntam-ti-dikaioumai";
const claimWingerHomeHref =
  "https://claimwinger.com/el?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_amsterdam_cancelled";
const delayedFlightHref =
  "https://claimwinger.com/el/kathysterimeni-ptisi?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_amsterdam_cancelled";
const cancelledFlightHref =
  "https://claimwinger.com/el/akyromeni-ptisi?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_amsterdam_cancelled";
...
const faqItems = [
  ...
  {
    question: "Γιατί σε αυτή τη διαδρομή μιλάμε συχνά για 400 €;",
    answer:
      "Γιατί η τυπική διαδρομή Αθήνα–Άμστερνταμ συνδέεται συνήθως με το επίπεδο άνω των 1.500 χλμ. αλλά κάτω από 3.500 χλμ., όπου η συνήθης αποζημίωση είναι 400 €.",
  },
];
...
export default function AthensAmsterdamCancelledFlightElPage() {
  return (
    <LayoutEl>
      <SEO
        title="Ακυρωμένη πτήση Αθήνα–Άμστερνταμ: τι δικαιούμαι;"
        description="Ακυρώθηκε η πτήση σας από Αθήνα προς Άμστερνταμ; Δείτε πότε υπάρχει επιστροφή χρημάτων, εναλλακτική μεταφορά και πιθανή αποζημίωση 400 € σύμφωνα με το EU261."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Ακυρωμένη πτήση Αθήνα–Άμστερνταμ: τι δικαιούμαι;",
            description:
              "Πρακτικός οδηγός για τα δικαιώματα του επιβάτη όταν ακυρώνεται πτήση Αθήνα–Άμστερνταμ, με έμφαση σε επιστροφή χρημάτων, εναλλακτική μεταφορά και αποζημίωση.",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Ακυρωμένη πτήση Αθήνα–Άμστερνταμ: τι δικαιούμαι;",
                item: articleUrl,
              },
            ],
          }),
      ...
      <article className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 dark:from-gray-950 dark:via-gray-900 dark:to-slate-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span>/</span>
            <span>Ακυρωμένη πτήση Αθήνα–Άμστερνταμ: τι δικαιούμαι;</span>
          </div>
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-emerald-100 px-4 py-2 text-sm font-medium text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300">
              Οδηγός διαδρομής για Αθήνα και Άμστερνταμ
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Ακυρωμένη πτήση Αθήνα–Άμστερνταμ: τι δικαιούμαι;
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Αν ακυρώθηκε η πτήση σας από <strong>Αθήνα προς Άμστερνταμ</strong>, το βασικό είναι να
              ξεχωρίσετε τρία πράγματα: <strong>επιστροφή χρημάτων</strong>,
              <strong> εναλλακτική μεταφορά</strong> και <strong>αποζημίωση</strong>. Δεν είναι το
              ίδιο, και σε αυτή τη διαδρομή η τυπική αποζημίωση είναι συχνά
              <strong> 400 €</strong>, όταν πληρούνται οι όροι του EU261.
            </p>
          ...
          <section className="mb-10">
            <Card className="border-emerald-200 bg-gradient-to-br from-emerald-600 to-teal-700 p-8 text-white shadow-xl dark:border-emerald-800">
              ...
              <div className="space-y-3 text-base leading-7 text-emerald-50">
                ...
                <p>
                  Για την τυπική διαδρομή Αθήνα–Άμστερνταμ, η πιο συχνή αναφορά για την αποζημίωση
                  είναι τα <strong>400 €</strong>, όταν η ενημέρωση έγινε αργά και δεν υπάρχουν
                  έγκυρες έκτακτες περιστάσεις.
                </p>
                <p>
                  Η εναλλακτική πτήση που προτείνει η αεροπορική μπορεί να επηρεάσει την υπόθεση,
                  αλλά δεν σημαίνει αυτόματα ότι το ζήτημα κλείνει χωρίς να εξεταστεί αποζημίωση.
                </p>
              </div>
            </Card>
          </section>
          ...
          <ClaimWingerElSection
            className="mb-12"
            title="Ακυρώθηκε η πτήση σας Αθήνα–Άμστερνταμ;"
            description="Το ClaimWinger Ελλάδα μπορεί να βοηθήσει να ξεχωρίσετε γρήγορα αν μιλάμε μόνο για επιστροφή χρημάτων ή και για ισχυρή αξίωση αποζημίωσης 400 € σύμφωνα με το EU261."
            ctaHref="https://claimwinger.com/el/akyromeni-ptisi?utm_source=problemlot-el&utm_medium=embedded_cta&utm_campaign=athens_amsterdam_cancelled"
            ...
            placement="el_blog_athens_amsterdam_cancelled_embed"
          />

          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Γιατί εδώ μιλάμε συχνά για 400 €
            </h2>
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Η τυπική διαδρομή Αθήνα–Άμστερνταμ συνδέεται συνήθως με το επίπεδο άνω των 1.500
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Το ότι η διαδρομή συνδέεται με 400 € δεν σημαίνει αυτόματα ότι κάθε ακύρωση
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="border-blue-200 p-6 dark:border-blue-800">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Αν αποφασίσετε να μην ταξιδέψετε, μπορεί να έχετε δικαίωμα επιστροφής της τιμής
              ...
              <Card className="border-amber-200 p-6 dark:border-amber-800">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Η αεροπορική μπορεί να σας βάλει σε άλλη πτήση, αλλά η ύπαρξη νέας διαδρομής δεν
                  κλείνει αυτόματα τη συζήτηση για αποζημίωση.
                </p>
              </Card>
              <Card className="border-green-200 p-6 dark:border-green-800">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Πρόκειται για ξεχωριστή χρηματική αξίωση. Στην τυπική διαδρομή Αθήνα–Άμστερνταμ
                  η πιο συχνή αναφορά είναι τα <strong>400 €</strong>.
                </p>
              </Card>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4">
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Δεν αρκεί ότι προσφέρθηκε μια άλλη πτήση. Μετρά πόσο κοντά έμειναν η νέα ώρα
          ...
          <section className="mb-12">
            <Card className="border-sky-200 bg-sky-50 p-6 dark:border-sky-900/50 dark:bg-sky-950/20">
              ...
              <div className="space-y-3 text-base leading-7 text-slate-700 dark:text-slate-300">
                <p>
                  Στη διαδρομή Αθήνα–Άμστερνταμ το πιο συχνό μπέρδεμα είναι ότι οι επιβάτες βλέπουν
                  μόνο τη νέα πτήση ή μόνο την επιστροφή χρημάτων και δεν ελέγχουν ποτέ αν υπήρχε και
                  ξεχωριστή αξίωση αποζημίωσης.
                </p>
                <p>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Button asChild className="bg-sky-600 hover:bg-sky-700">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick("el_blog_athens_amsterdam_cancelled_inline", claimWingerHomeHref)
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_amsterdam_cancelled_cancelled",
                        cancelledFlightHref,
                      )
                    }
                  >
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <Card className="p-6">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Χρήσιμο όταν η ακύρωση συνοδεύτηκε από νέα πρόταση με σημαντικά διαφορετικό
                  πρόγραμμα.
                </p>
                <Link
          ...
          <section className="mb-12">
            <Card className="border-slate-200 p-8 dark:border-slate-700">
              ...
              <div className="space-y-4 text-base leading-7 text-slate-700 dark:text-slate-300">
                <p>
                  Σε μια ακυρωμένη πτήση Αθήνα–Άμστερνταμ, το βασικό είναι να μη σταματήσετε μόνο στην
                  επιστροφή χρημάτων ή στην ύπαρξη μιας νέας πτήσης. Αυτά είναι σημαντικά, αλλά δεν
                  εξαντλούν πάντα τα δικαιώματά σας.
                </p>
                <p>
          ...
          <section className="mb-6">
            <Card className="border-sky-200 bg-white p-8 shadow-sm dark:border-sky-900/40 dark:bg-slate-950/60">
              <h2 className="mb-3 text-2xl font-bold text-slate-900 dark:text-white">
                Θέλετε να δείτε γρήγορα αν η ακύρωση Αθήνα–Άμστερνταμ έχει βάση για αποζημίωση;
              </h2>
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild className="bg-sky-600 hover:bg-sky-700">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_amsterdam_cancelled_footer_home",
                        claimWingerHomeHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_amsterdam_cancelled_footer_delayed",
                        delayedFlightHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_amsterdam_cancelled_footer_cancelled",
                        cancelledFlightHref,
                      )
                    }
                  >
