...
const articleUrl =
  "https://problemlot.com/el/blog/apozimiosi-gia-kathysterisi-ptisis-athina-londino";
const claimWingerHomeHref =
  "https://claimwinger.com/el?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_london_delay";
const delayedFlightHref =
  "https://claimwinger.com/el/kathysterimeni-ptisi?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_london_delay";
const cancelledFlightHref =
  "https://claimwinger.com/el/akyromeni-ptisi?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_london_delay";
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Για μια τυπική απευθείας πτήση Αθήνα–Λονδίνο, η διαδρομή συνήθως μπαίνει στο επίπεδο των 400 €, γιατί πρόκειται συνήθως για πτήση άνω των 1.500 χλμ. αλλά κάτω από 3.500 χλμ.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Αν το Λονδίνο ήταν μόνο ενδιάμεσος σταθμός σε μία ενιαία κράτηση, τότε μπορεί να μετρά περισσότερο η τελική άφιξη ολόκληρου του ταξιδιού και όχι μόνο το σκέλος Αθήνα–Λονδίνο.",
  },
];
...
export default function AthensLondonDelayCompensationElPage() {
  return (
    <LayoutEl>
      <SEO
        title="Αποζημίωση για καθυστέρηση πτήσης Αθήνα–Λονδίνο"
        description="Καθυστέρησε η πτήση σας από Αθήνα προς Λονδίνο; Δείτε πότε υπάρχει αποζημίωση, γιατί η διαδρομή συνήθως οδηγεί σε 400 € και τι ισχύει μετά το Brexit."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Αποζημίωση για καθυστέρηση πτήσης Αθήνα–Λονδίνο",
            description:
              "Πρακτικός οδηγός για το πότε μια καθυστέρηση πτήσης Αθήνα–Λονδίνο μπορεί να οδηγεί σε αποζημίωση και γιατί η διαδρομή αυτή συνδέεται συχνά με ποσό 400 €.",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Αποζημίωση για καθυστέρηση πτήσης Αθήνα–Λονδίνο",
                item: articleUrl,
              },
            ],
          }),
      ...
      <article className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-sky-50 dark:from-gray-950 dark:via-gray-900 dark:to-slate-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span>/</span>
            <span>Αποζημίωση για καθυστέρηση πτήσης Αθήνα–Λονδίνο</span>
          </div>
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-sky-100 px-4 py-2 text-sm font-medium text-sky-700 dark:bg-sky-900/30 dark:text-sky-300">
              Οδηγός διαδρομής για Αθήνα και Λονδίνο
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Αποζημίωση για καθυστέρηση πτήσης Αθήνα–Λονδίνο
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Σε μια τυπική πτήση <strong>Αθήνα–Λονδίνο</strong>, η απάντηση είναι συχνά θετική:
              αν φτάσατε με καθυστέρηση τουλάχιστον <strong>3 ωρών</strong>, η διαδρομή εμπίπτει στο
              <strong> EU261</strong> και η αεροπορική δεν αποδείξει έγκυρες έκτακτες περιστάσεις,
              μπορεί να υπάρχει αποζημίωση. Για αυτή τη διαδρομή η πιο τυπική κατηγορία είναι
              <strong> 400 €</strong>.
            </p>
            ...
            <Card className="border-sky-200 bg-gradient-to-br from-sky-600 to-blue-700 p-8 text-white shadow-xl dark:border-sky-800">
              ...
              <div className="space-y-3 text-base leading-7 text-sky-50">
                <p>
                  ...
                  EU261 εξακολουθεί να εφαρμόζεται και στη διαδρομή προς το Ηνωμένο Βασίλειο.
                </p>
                <p>
                  Για μια απευθείας πτήση Αθήνα–Λονδίνο, η αποζημίωση συνήθως συνδέεται με το επίπεδο
                  των <strong>400 €</strong>, όχι με τα 250 € που βλέπουμε σε σαφώς κοντύτερες
                  διαδρομές.
                </p>
                <p>
          ...
          <ClaimWingerElSection
            className="mb-12"
            title="Καθυστέρησε η πτήση σας Αθήνα–Λονδίνο;"
            ...
            ctaHref="https://claimwinger.com/el/kathysterimeni-ptisi?utm_source=problemlot-el&utm_medium=embedded_cta&utm_campaign=athens_london_delay"
            ...
            placement="el_blog_athens_london_delay_embed"
          />

          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 dark:text-white">
              Γιατί αυτή η διαδρομή είναι ιδιαίτερα καθαρή από πλευράς EU261
            </h2>
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Επειδή η πτήση ξεκινά από την Αθήνα, δηλαδή από αεροδρόμιο της Ευρωπαϊκής Ένωσης,
                  το EU261 εφαρμόζεται κανονικά και στη διαδρομή προς το Λονδίνο.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Το Brexit αλλάζει κυρίως τον τρόπο που διαβάζουμε ορισμένες πτήσεις από το Ηνωμένο
                  Βασίλειο προς την ΕΕ. Για το σκέλος Αθήνα–Λονδίνο, η ευρωπαϊκή προστασία παραμένει
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="border-green-200 p-6 dark:border-green-800">
                <h3 className="mb-2 text-xl font-semibold text-slate-900 dark:text-white">
                  Απευθείας Αθήνα–Λονδίνο
                </h3>
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Αν πετούσατε point-to-point και φτάσατε στο Λονδίνο με καθυστέρηση τουλάχιστον 3
                  ωρών, η πιο συχνή αποζημίωση για αυτή τη διαδρομή είναι <strong>400 €</strong>.
                </p>
              </Card>
              <Card className="border-amber-200 p-6 dark:border-amber-800">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Αν το Λονδίνο δεν ήταν ο τελικός προορισμός αλλά μέρος μιας ενιαίας κράτησης, τότε
                  μπορεί να μετρά η συνολική απόσταση και η καθυστέρηση στην άφιξη της ολόκληρης
                  διαδρομής.
                </p>
              </Card>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4">
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Για αυτή τη διαδρομή χρειάζεται προσοχή, γιατί πολλοί επιβάτες υποθέτουν από
                  συνήθεια τα 250 €. Στην πράξη, για το κλασικό Αθήνα–Λονδίνο η σωστή αναφορά είναι
                  συνήθως τα <strong>400 €</strong>.
                </p>
              </Card>
            </div>
          </section>
          ...
          <section className="mb-12">
            <Card className="border-sky-200 bg-sky-50 p-6 dark:border-sky-900/50 dark:bg-sky-950/20">
              ...
              <div className="space-y-3 text-base leading-7 text-slate-700 dark:text-slate-300">
                <p>
                  Στη διαδρομή Αθήνα–Λονδίνο το πιο συχνό λάθος δεν είναι τόσο η ύπαρξη του
                ...
                <p>
                  Σε αυτό το σημείο το <strong>ClaimWinger</strong> μπορεί να βοηθήσει να ξεχωρίσετε
                  αν μιλάμε για καθαρή route case ή για σύνθετη υπόθεση με τελικό προορισμό αλλού.
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Button asChild className="bg-sky-600 hover:bg-sky-700">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick("el_blog_athens_london_delay_inline", claimWingerHomeHref)
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick("el_blog_athens_london_delay_delayed", delayedFlightHref)
                    }
                  >
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <Card className="p-6">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Χρήσιμο αν το πρόβλημα δεν ήταν μόνο καθυστέρηση αλλά τελικά οδήγησε σε ακύρωση ή
                  νέα κράτηση σε άλλη πτήση.
                </p>
                <Link
          ...
          <section className="mb-12">
            <Card className="border-slate-200 p-8 dark:border-slate-700">
              ...
              <div className="space-y-4 text-base leading-7 text-slate-700 dark:text-slate-300">
                <p>
                  Η διαδρομή Αθήνα–Λονδίνο είναι από εκείνες όπου το βασικό νομικό πλαίσιο είναι
                  αρκετά καθαρό: αναχώρηση από ΕΕ, προστασία EU261 και συχνά αποζημίωση στο επίπεδο
                  των 400 € όταν η καθυστέρηση στην άφιξη περάσει το όριο.
                </p>
                <p>
          ...
          <section className="mb-6">
            <Card className="border-sky-200 bg-white p-8 shadow-sm dark:border-sky-900/40 dark:bg-slate-950/60">
              <h2 className="mb-3 text-2xl font-bold text-slate-900 dark:text-white">
                Θέλετε να δείτε γρήγορα αν η καθυστέρηση Αθήνα–Λονδίνο έχει βάση για αποζημίωση;
              </h2>
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild className="bg-sky-600 hover:bg-sky-700">
                  <Link
                    href={claimWingerHomeHref}
                    onClick={() =>
                      trackClaimClick("el_blog_athens_london_delay_footer_home", claimWingerHomeHref)
                    }
                  >
                    ClaimWinger Ελλάδα
                    <ArrowRight className="ml-2 h-4 w-4" />
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_london_delay_footer_delayed",
                        delayedFlightHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_london_delay_footer_cancelled",
                        cancelledFlightHref,
                      )
                    }
                  >
