...
const articleUrl =
  "https://problemlot.com/el/blog/akyromeni-ptisi-athina-santorini-ti-dikaioumai";
const claimWingerHomeHref =
  "https://claimwinger.com/el?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_santorini_cancelled";
const delayedFlightHref =
  "https://claimwinger.com/el/kathysterimeni-ptisi?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_santorini_cancelled";
const cancelledFlightHref =
  "https://claimwinger.com/el/akyromeni-ptisi?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=athens_santorini_cancelled";
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Γιατί η τυπική διαδρομή Αθήνα–Σαντορίνη είναι εσωτερική πτήση μικρότερης απόστασης, οπότε το πιο συνηθισμένο επίπεδο αποζημίωσης είναι τα 250 €.",
  },
];
...
export default function AthensSantoriniCancelledFlightElPage() {
  return (
    <LayoutEl>
      <SEO
        title="Ακυρωμένη πτήση Αθήνα–Σαντορίνη: τι δικαιούμαι;"
        description="Ακυρώθηκε η πτήση σας από Αθήνα προς Σαντορίνη; Δείτε πότε υπάρχει επιστροφή χρημάτων, εναλλακτική μεταφορά και πιθανή αποζημίωση 250 € σύμφωνα με το EU261."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Ακυρωμένη πτήση Αθήνα–Σαντορίνη: τι δικαιούμαι;",
            description:
              "Πρακτικός οδηγός για τα δικαιώματα του επιβάτη όταν ακυρώνεται πτήση Αθήνα–Σαντορίνη, με έμφαση σε επιστροφή χρημάτων, εναλλακτική μεταφορά και αποζημίωση.",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Ακυρωμένη πτήση Αθήνα–Σαντορίνη: τι δικαιούμαι;",
                item: articleUrl,
              },
            ],
          }),
      ...
      <article className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 dark:from-gray-950 dark:via-gray-900 dark:to-slate-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span>/</span>
            <span>Ακυρωμένη πτήση Αθήνα–Σαντορίνη: τι δικαιούμαι;</span>
          </div>
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-emerald-100 px-4 py-2 text-sm font-medium text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300">
              Οδηγός διαδρομής για Αθήνα και Σαντορίνη
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Ακυρωμένη πτήση Αθήνα–Σαντορίνη: τι δικαιούμαι;
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Αν ακυρώθηκε η πτήση σας από <strong>Αθήνα προς Σαντορίνη</strong>, είναι σημαντικό
              ...
              είναι το ίδιο και, για την τυπική διαδρομή Αθήνα–Σαντορίνη, η πιο συνηθισμένη
          ...
          <section className="mb-10">
            <Card className="border-emerald-200 bg-gradient-to-br from-emerald-600 to-teal-700 p-8 text-white shadow-xl dark:border-emerald-800">
              ...
              <div className="space-y-3 text-base leading-7 text-emerald-50">
                ...
                <p>
                  Για τη διαδρομή Αθήνα–Σαντορίνη η πιο συνηθισμένη αναφορά για την αποζημίωση είναι
          ...
          <ClaimWingerElSection
            className="mb-12"
            title="Ακυρώθηκε η πτήση σας Αθήνα–Σαντορίνη;"
            ...
            ctaHref="https://claimwinger.com/el/akyromeni-ptisi?utm_source=problemlot-el&utm_medium=embedded_cta&utm_campaign=athens_santorini_cancelled"
            ...
            placement="el_blog_athens_santorini_cancelled_embed"
          />
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Η τυπική διαδρομή Αθήνα–Σαντορίνη είναι εσωτερική πτήση μικρότερης απόστασης,
                  όπου το πιο συνηθισμένο επίπεδο αποζημίωσης είναι 250 €.
                </p>
              </Card>
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                <h3 className="mb-2 text-lg font-semibold text-slate-900 dark:text-white">
          ...
          <section className="mb-12">
            <Card className="border-sky-200 bg-sky-50 p-6 dark:border-sky-900/50 dark:bg-sky-950/20">
              ...
              <div className="space-y-3 text-base leading-7 text-slate-700 dark:text-slate-300">
                <p>
                  Στη διαδρομή Αθήνα–Σαντορίνη ο βασικός νομικός κορμός είναι σχετικά καθαρός, αλλά
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Button asChild className="bg-sky-600 hover:bg-sky-700">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_santorini_cancelled_inline",
                        claimWingerHomeHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_santorini_cancelled_cancelled",
                        cancelledFlightHref,
                      )
                    }
                  >
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="p-6">
                <h3 className="mb-3 text-lg font-semibold text-slate-900 dark:text-white">
                  Ακυρωμένη πτήση Αθήνα–Ηράκλειο
                </h3>
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Χρήσιμο αν θέλετε να συγκρίνετε παρόμοια περίπτωση ακυρωμένης πτήσης σε μια άλλη
                  σύντομη εσωτερική διαδρομή.
                </p>
                <Link
                  href="/el/blog/akyromeni-ptisi-athina-irakleio-ti-dikaioumai"
          ...
          <section className="mb-12">
            <Card className="border-slate-200 p-8 dark:border-slate-700">
              ...
              <div className="space-y-4 text-base leading-7 text-slate-700 dark:text-slate-300">
                <p>
                  Η ακυρωμένη πτήση Αθήνα–Σαντορίνη είναι μια καλή περίπτωση για να δει κανείς
          ...
          <section className="mb-6">
            <Card className="border-sky-200 bg-white p-8 shadow-sm dark:border-sky-900/40 dark:bg-slate-950/60">
              <h2 className="mb-3 text-2xl font-bold text-slate-900 dark:text-white">
                Θέλετε να δείτε γρήγορα αν η ακύρωση Αθήνα–Σαντορίνη δίνει βάση για αποζημίωση;
              </h2>
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild className="bg-sky-600 hover:bg-sky-700">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_santorini_cancelled_footer_home",
                        claimWingerHomeHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_santorini_cancelled_footer_cancelled",
                        cancelledFlightHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_athens_santorini_cancelled_footer_delayed",
                        delayedFlightHref,
                      )
                    }
                  >
