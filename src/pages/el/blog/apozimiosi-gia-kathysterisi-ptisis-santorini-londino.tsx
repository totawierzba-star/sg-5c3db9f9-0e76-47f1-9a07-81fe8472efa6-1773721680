...
const articleUrl =
  "https://problemlot.com/el/blog/apozimiosi-gia-kathysterisi-ptisis-santorini-londino";
const claimWingerHomeHref =
  "https://claimwinger.com/el?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=santorini_london_delay";
const delayedFlightHref =
  "https://claimwinger.com/el/kathysterimeni-ptisi?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=santorini_london_delay";
const cancelledFlightHref =
  "https://claimwinger.com/el/akyromeni-ptisi?utm_source=problemlot-el&utm_medium=article_link&utm_campaign=santorini_london_delay";
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Για μια τυπική απευθείας πτήση Σαντορίνη–Λονδίνο, η αποζημίωση συνδέεται συνήθως με το επίπεδο των 400 €, γιατί μιλάμε συνήθως για πτήση άνω των 1.500 χλμ. αλλά κάτω από 3.500 χλμ.",
  },
  {
    question: "Ισχύει αυτό και μετά το Brexit;",
    answer:
      "Ναι. Εφόσον η πτήση αναχωρεί από τη Σαντορίνη, δηλαδή από αεροδρόμιο της ΕΕ, το EU261 εξακολουθεί να εφαρμόζεται και στη διαδρομή προς το Ηνωμένο Βασίλειο.",
  },
  {
    question: "Τι γίνεται αν το Λονδίνο δεν ήταν ο τελικός προορισμός;",
    answer:
      "Αν το Λονδίνο ήταν μόνο ενδιάμεσος σταθμός σε μία ενιαία κράτηση, τότε μπορεί να μετρά περισσότερο η τελική άφιξη ολόκληρου του ταξιδιού και όχι μόνο το σκέλος Σαντορίνη–Λονδίνο.",
  },
];
...
export default function SantoriniLondonDelayCompensationElPage() {
  return (
    <LayoutEl>
      <SEO
        title="Αποζημίωση για καθυστέρηση πτήσης Σαντορίνη–Λονδίνο"
        description="Καθυστέρησε η πτήση σας από Σαντορίνη προς Λονδίνο; Δείτε πότε μπορεί να υπάρχει αποζημίωση 400 €, τι σημαίνει το EU261 και γιατί μετρά η τελική άφιξη."
        url={articleUrl}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Αποζημίωση για καθυστέρηση πτήσης Σαντορίνη–Λονδίνο",
            description:
              "Πρακτικός οδηγός για το πότε μια καθυστέρηση πτήσης Σαντορίνη–Λονδίνο μπορεί να οδηγεί σε αποζημίωση και γιατί η διαδρομή αυτή συνδέεται συχνά με ποσό 400 €.",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Αποζημίωση για καθυστέρηση πτήσης Σαντορίνη–Λονδίνο",
                item: articleUrl,
              },
            ],
          }),
      ...
      <article className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-sky-50 dark:from-gray-950 dark:via-gray-900 dark:to-slate-900">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            <span>/</span>
            <span>Αποζημίωση για καθυστέρηση πτήσης Σαντορίνη–Λονδίνο</span>
          </div>
          ...
          <header className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-sky-100 px-4 py-2 text-sm font-medium text-sky-700 dark:bg-sky-900/30 dark:text-sky-300">
              Οδηγός διαδρομής για Σαντορίνη και Λονδίνο
            </div>
            <h1 className="mb-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Αποζημίωση για καθυστέρηση πτήσης Σαντορίνη–Λονδίνο
            </h1>
            <p className="max-w-3xl text-xl leading-8 text-slate-600 dark:text-slate-300">
              Σε μια τυπική πτήση <strong>Σαντορίνη–Λονδίνο</strong>, η απάντηση είναι συχνά
          ...
          <section className="mb-10">
            <Card className="border-sky-200 bg-gradient-to-br from-sky-600 to-blue-700 p-8 text-white shadow-xl dark:border-sky-800">
              ...
              <div className="space-y-3 text-base leading-7 text-sky-50">
                ...
                <p>
                  Για μια απευθείας πτήση Σαντορίνη–Λονδίνο, η αποζημίωση συνήθως συνδέεται με το
          ...
          <ClaimWingerElSection
            className="mb-12"
            title="Καθυστέρησε η πτήση σας Σαντορίνη–Λονδίνο;"
            ...
            ctaHref="https://claimwinger.com/el/kathysterimeni-ptisi?utm_source=problemlot-el&utm_medium=embedded_cta&utm_campaign=santorini_london_delay"
            ...
            placement="el_blog_santorini_london_delay_embed"
          />
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Επειδή η πτήση ξεκινά από τη Σαντορίνη, δηλαδή από αεροδρόμιο της Ευρωπαϊκής
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  ...
                  προς την ΕΕ. Για το σκέλος Σαντορίνη–Λονδίνο, η ευρωπαϊκή προστασία παραμένει
            ...
            <div className="grid gap-4">
              ...
              <Card className="border-slate-200 p-6 dark:border-slate-700">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                  ...
                  συνήθεια τα 250 €. Στην πράξη, για το κλασικό Σαντορίνη–Λονδίνο η σωστή αναφορά
                  είναι συνήθως τα <strong>400 €</strong>.
                </p>
              </Card>
            </div>
          </section>
          ...
          <section className="mb-12">
            <Card className="border-sky-200 bg-sky-50 p-6 dark:border-sky-900/50 dark:bg-sky-950/20">
              ...
              <div className="space-y-3 text-base leading-7 text-slate-700 dark:text-slate-300">
                <p>
                  Στη διαδρομή Σαντορίνη–Λονδίνο το πιο συχνό λάθος δεν είναι τόσο η ύπαρξη του
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Button asChild className="bg-sky-600 hover:bg-sky-700">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_santorini_london_delay_inline",
                        claimWingerHomeHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_santorini_london_delay_delayed",
                        delayedFlightHref,
                      )
                    }
                  >
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="p-6">
                ...
                <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Χρήσιμο αν θέλετε να συγκρίνετε παρόμοια διαδρομή από άλλη μεγάλη ελληνική νησιωτική αφετηρία.
                </p>
                <Link
                  href="/el/blog/akyromeni-ptisi-rodos-londino-ti-dikaioumai"
          ...
          <section className="mb-12">
            <Card className="border-slate-200 p-8 dark:border-slate-700">
              ...
              <div className="space-y-4 text-base leading-7 text-slate-700 dark:text-slate-300">
                <p>
                  Η διαδρομή Σαντορίνη–Λονδίνο είναι από εκείνες όπου το βασικό νομικό πλαίσιο είναι
                  αρκετά καθαρό: αναχώρηση από ΕΕ, προστασία EU261 και συχνά αποζημίωση στο επίπεδο
                  των 400 € όταν η καθυστέρηση στην άφιξη περάσει το σχετικό όριο.
                </p>
                <p>
          ...
          <section className="mb-6">
            <Card className="border-sky-200 bg-white p-8 shadow-sm dark:border-sky-900/40 dark:bg-slate-950/60">
              <h2 className="mb-3 text-2xl font-bold text-slate-900 dark:text-white">
                Θέλετε να δείτε γρήγορα αν η καθυστέρηση Σαντορίνη–Λονδίνο έχει βάση για αποζημίωση;
              </h2>
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild className="bg-sky-600 hover:bg-sky-700">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_santorini_london_delay_footer_home",
                        claimWingerHomeHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_santorini_london_delay_footer_delayed",
                        delayedFlightHref,
                      )
                    }
                  >
                ...
                <Button asChild variant="outline">
                  <Link
                    ...
                    onClick={() =>
                      trackClaimClick(
                        "el_blog_santorini_london_delay_footer_cancelled",
                        cancelledFlightHref,
                      )
                    }
                  >
